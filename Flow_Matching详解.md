...
**Flow Matching 的目标：** 训练一个神经网络 $v_\theta(x_t, t)$ 来拟合这个真实的速度场。
...
$$L_{FM} = \mathbb{E}_{t \sim \mathcal{U}[0,1], x_0 \sim p_{data}, x_1 \sim \mathcal{N}(0,I)} \| v_\theta(x_t, t) - (x_1 - x_0) \|^2$$
