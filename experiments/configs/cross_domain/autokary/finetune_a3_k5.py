"""跨域 Few-shot 微调: LDMDet +Stoch. Coupling (RF+Heun+AdaLN+StochOT eps5) on AutoKary k=5
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            description='Few-shot k=5: LDMDet +Stoch. Coupling (StochOT+AdaLN) 24obj→AutoKary | lr=5e-6, 50ep',
