"""24obj RF+Heun shifted schedule 参数扫描: shift=5.0

目的: 验证 shift=3.0 是否为最优值, 更大 shift 是否对小目标有帮助
对照: shift=1 (unshifted) / shift=2 / shift=3 (RF+Heun, 0.856) / shift=5 (本实验)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            description='24obj RF+Heun shift=5.0 | bs=8, 150ep',
