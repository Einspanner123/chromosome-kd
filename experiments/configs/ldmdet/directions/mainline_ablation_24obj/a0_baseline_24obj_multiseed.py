"""24obj DDPM baseline baseline 多种子训练配置 (DeepSeek Major Concern 2 补充实验)

用途: DDPM baseline baseline 多种子实验 (seed 123, 789), 用于统计显著性分析
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            description='24obj DDPM baseline baseline 多种子 | bs=4, 150ep',
