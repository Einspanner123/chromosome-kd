"""Few-shot target finetune: RTMDet-L on chromo k=10.
...
_base_ = [
    '../../../../projects/LDMDet/configs/benchmark_24obj/rtmdet_l.py'
]
...
ckpt_pattern = (
    'work_dirs/few_shot/source_pretrain_rtmdet_l_24obj/'
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='target_finetune_rtmdet_l_k10',
                description='Few-shot target finetune: RTMDet-L on '
