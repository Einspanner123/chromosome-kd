"""Few-shot target finetune: LDMDet + FBM Cross-Attn on chromo k=10.
...
_base_ = ['../source_pretrain/ldmdet_fbm_crossattn_24obj.py']
...
ckpt_pattern = (
    'work_dirs/few_shot/source_pretrain_ldmdet_fbm_crossattn_24obj/'
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='target_finetune_ldmdet_fbm_crossattn_k10',
                description='Few-shot target finetune: LDMDet + FBM '
                'Cross-Attn on chromo k=10 | bs=2, 50ep',
            ),
        ),
    ],
)
