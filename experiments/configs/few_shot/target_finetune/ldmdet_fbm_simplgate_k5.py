"""Few-shot target finetune: LDMDet + FBM Simple Gate on chromo k=5.
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='target_finetune_ldmdet_fbm_simplgate_k5',
                description='Few-shot target finetune: LDMDet + FBM '
                'Simple Gate on chromo k=5 | bs=2, 50ep',
            ),
        ),
    ],
)
