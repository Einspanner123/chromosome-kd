"""Few-shot target finetune: LDMDet SOTA on chromo k=10.

Inherits from 24obj source pretrain, switches dataset to chromo few-shot,
and lowers the learning rate for fine-tuning.
"""
import glob

_base_ = ['../source_pretrain/ldmdet_sota_24obj.py']
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='target_finetune_ldmdet_sota_k10',
                description='Few-shot target finetune: LDMDet SOTA on '
