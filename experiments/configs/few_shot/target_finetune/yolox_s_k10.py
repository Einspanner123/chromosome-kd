"""Few-shot target finetune: YOLOX-S on chromo k=10.
...
_base_ = [
    '../../../../projects/LDMDet/configs/benchmark_24obj/yolox_s.py'
]
...
# Override the inner CocoDataset inside MultiImageMixDataset
...
ckpt_pattern = (
    'work_dirs/few_shot/source_pretrain_yolox_s_24obj/'
...
# === Custom hooks (keep YOLOXModeSwitchHook + EMAHook, lower patience) ===
custom_hooks = [
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='target_finetune_yolox_s_k10',
                description='Few-shot target finetune: YOLOX-S on '
                'chromo k=10 | bs=8, 50ep',
            ),
        ),
    ],
)
