...
# train_dataloader = dict(dataset=dict(proposal_file='proposals/crpn_r50_caffe_fpn_1x_train2017.pkl'))
_base_.train_dataloader.dataset.proposal_file = (
    'proposals/crpn_r50_caffe_fpn_1x_train2017.pkl'
)

# val_dataloader = dict(dataset=dict(proposal_file='proposals/crpn_r50_caffe_fpn_1x_val2017.pkl'))
