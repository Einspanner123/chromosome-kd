...
class TestCondInstHead(TestCase):
    def test_condinst_bboxhead_loss(self):
        ...
        self.assertGreater(
            onegt_ctr_loss, 0, 'centerness loss should be non-zero'
        )
        ...
        self.assertGreater(
            ctrsamp_ctr_loss, 0, 'centerness loss should be non-zero'
        )
        ...
        self.assertGreater(
            normbox_ctr_loss, 0, 'centerness loss should be non-zero'
        )
