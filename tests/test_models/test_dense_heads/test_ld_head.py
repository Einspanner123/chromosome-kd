...
class TestLDHead(TestCase):
    def test_ld_head_loss(self):
        ...
        self.assertGreater(
            empty_cls_loss.item(), 0, 'cls loss should be non-zero'
        )
        self.assertEqual(
            empty_box_loss.item(),
            0,
        ...
        self.assertGreater(
            onegt_cls_loss.item(), 0, 'cls loss should be non-zero'
        )
        self.assertGreater(
            onegt_box_loss.item(), 0, 'box loss should be non-zero'
        )
        ...
        self.assertGreater(
            ignore_cls_loss.item(), 0, 'cls loss should be non-zero'
        )
        self.assertEqual(
        ...
        self.assertGreater(
            not_ignore_cls_loss.item(), 0, 'cls loss should be non-zero'
        )
        self.assertGreaterEqual(
            not_ignore_box_loss.item(),
            0,
