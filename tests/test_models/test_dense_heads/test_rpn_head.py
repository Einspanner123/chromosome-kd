...
class TestRPNHead(TestCase):
    ...
    def test_rpn_head_loss(self):
        ...
        self.assertGreater(
            empty_cls_loss.item(), 0, 'rpn cls loss should be non-zero'
        )
        self.assertEqual(
            empty_box_loss.item(),
            0,
        ...
        self.assertGreater(
            onegt_cls_loss.item(), 0, 'rpn cls loss should be non-zero'
        )
        self.assertGreater(
            onegt_box_loss.item(), 0, 'rpn box loss should be non-zero'
        )
