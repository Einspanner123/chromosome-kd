...
class TestGuidedAnchorHead(TestCase):
    def test_guided_anchor_head_loss(self):
        ...
        s = 256
        img_metas = [
            {'img_shape': (s, s), 'pad_shape': (s, s), 'scale_factor': (1, 1)}
        ]
        ...
        self.assertGreater(
            empty_loc_loss, 0, 'location loss should be non-zero'
        )
        self.assertEqual(
            empty_box_loss,
            0,
        ...
        self.assertGreater(
            onegt_shape_loss, 0, 'shape loss should be non-zero'
        )
        self.assertGreater(
            onegt_loc_loss, 0, 'location loss should be non-zero'
        )
