        ...
        for config in configs:
            ...
            for key, loss in empty_gt_losses.items():
                if 'aux' in key:
                    self.assertEqual(
                        ...
                        (
                            ...
                            + r'it should be {}'
                        ).format(key, len(loss), len(batch_data_samples_1)),
                    )
                ...
                if any(
                    ...
                    self.assertGreater(
                        _loss, 0, f'{key}({_loss}) should be non-zero'
                    )
                ...
                if 'aux' in key:
                    self.assertEqual(
                        ...
                        (
                            r'Actual aux loss count for {} is {},'
                            + r'it should be {}'
                        ).format(key, len(loss), len(batch_data_samples_2)),
                    )
