...
class TestBrightness(unittest.TestCase):
    ...
    def test_brightness(self):
        ...
        check_result_same(
            self.results_mask, results_wo_brightness, self.check_keys
        )
        # test case when level=0
...
class TestContrast(unittest.TestCase):
    ...
    def test_contrast(self):
        ...
        check_result_same(
            self.results_mask, results_wo_contrast, self.check_keys
        )
        # test case when level=0
...
class TestSharpness(unittest.TestCase):
    ...
    def test_sharpness(self):
        ...
        check_result_same(
            self.results_mask, results_wo_sharpness, self.check_keys
        )
        # test case when level=0
...
class TestSolarize(unittest.TestCase):
    ...
    def test_solarize(self):
        ...
        check_result_same(
            self.results_mask, results_wo_solarize, self.check_keys
        )
        # test case when level=0
...
class TestSolarizeAdd(unittest.TestCase):
    ...
    def test_solarize(self):
        ...
        check_result_same(
            self.results_mask, results_wo_solarizeadd, self.check_keys
        )
        # test case when level=10
...
class TestPosterize(unittest.TestCase):
    ...
    def test_posterize(self):
        ...
        check_result_same(
            self.results_mask, results_wo_posterize, self.check_keys
        )
        # test case when level=0
...
class TestEqualize(unittest.TestCase):
    ...
    def test_equalize(self):
        ...
        check_result_same(
            self.results_mask, results_wo_equalize, self.check_keys
        )
...
class TestAutoContrast(unittest.TestCase):
    ...
    def test_autocontrast(self):
        ...
        check_result_same(
            self.results_mask, results_wo_autocontrast, self.check_keys
        )
        # test case when translation is called
...
class TestInvert(unittest.TestCase):
    ...
    def test_invert(self):
        ...
        check_result_same(
            self.results_mask, results_wo_invert, self.check_keys
        )
        # test case when translation is called
