...
class TestMultiBranch(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        for branch in sup_branches:
            ...
            self.assertIn(
                'homography_matrix', labeled_results['data_samples'][branch]
            )
            self.assertIn(
            ...
            self.assertIn(
                'masks', labeled_results['data_samples'][branch].gt_instances
            )
            self.assertIn(
                'gt_sem_seg', labeled_results['data_samples'][branch]
            )
        ...
        for branch in unsup_branches:
            ...
            self.assertNotIn(
                'gt_sem_seg', unlabeled_results['data_samples'][branch]
            )
...
class TestRandomOrder(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        self.assertEqual(
            results['gt_bboxes'].shape, self.results['gt_bboxes'].shape
        )
        self.assertEqual(
            results['gt_bboxes_labels'], self.results['gt_bboxes_labels']
        )
        self.assertEqual(
            results['gt_ignore_flags'], self.results['gt_ignore_flags']
        )
        self.assertEqual(
        ...
        self.assertEqual(
            results['gt_seg_map'].shape, self.results['gt_seg_map'].shape
        )
