...
class TestPackDetInputs(unittest.TestCase):
    def setUp(self):
        ...
        self.results1 = {
            ...
            'gt_masks': BitmapMasks(
                rng.rand(3, 300, 400), height=300, width=400
            ),
    ...
    def test_transform(self):
        ...
        self.assertIsInstance(
            results['data_samples'].gt_instances, InstanceData
        )
        self.assertIsInstance(
            results['data_samples'].ignored_instances, InstanceData
        )
        ...
        self.assertIsInstance(
            results['data_samples'].proposals.bboxes, torch.Tensor
        )
        self.assertIsInstance(
            results['data_samples'].proposals.scores, torch.Tensor
        )
