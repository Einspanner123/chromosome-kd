...
from .noise_schedule import load_buffer
from .rectified_flow import RFDPMSolverMultistep
from .structures import DetectionResult, ImageMeta
...
class DiffusionSampler:
    ...
    def apply_box_renewal(self, x_raw: Tensor, cls_logits: Tensor) -> Tensor:
        """框更新策略：低置信度框替换为随机噪声"""
