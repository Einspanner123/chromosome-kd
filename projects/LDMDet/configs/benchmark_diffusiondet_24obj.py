...
experiment_name = 'benchmark_diffusiondet_24obj'
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                description='Benchmark 24obj: Vanilla DiffusionDet (DDPM+Euler+scale_shift+no OT) | ResNet-50+FPN | 24obj dataset | AdamW lr5e-5 bs2 | 150ep CosineAnnealing',
            ),
        ),
    ]
)
