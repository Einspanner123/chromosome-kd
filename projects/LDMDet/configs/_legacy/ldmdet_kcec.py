"""Karyotype-Constrained Entropic Coupling (KCEC).

Slot-based coupling that combines transport efficiency, morphology priors,
group priors, soft ploidy quotas, and homologous exchangeability.
See THEORY_FRAMEWORK.md §8.6 for the full theoretical derivation.
"""
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='kcec',
                description='KCEC training with slot-based coupling',
            ),
        ),
    ],
)

work_dir = 'work_dirs/ldmdet_kcec'
