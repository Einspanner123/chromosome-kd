"""KCEC ablation: group + quota + morphology (no slack for abnormal karyotypes)."""
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                experiment_name='ablation-group-quota-morph',
                description='KCEC ablation: group + quota + morphology (no slack)',
            ),
        ),
    ],
)

work_dir = 'work_dirs/ldmdet_kcec_ablation_group_quota_morph'
