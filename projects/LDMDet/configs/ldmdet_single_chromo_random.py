...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type, data_root=data_root, metainfo=METAINFO,
        ann_file="annotations/train.json", data_prefix=dict(img="JEPG/"),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type, data_root=data_root, metainfo=METAINFO,
        ann_file="annotations/val.json", data_prefix=dict(img="JEPG/"),
...
val_evaluator = dict(
    ...
    metric="bbox", format_only=False, backend_args=backend_args)
