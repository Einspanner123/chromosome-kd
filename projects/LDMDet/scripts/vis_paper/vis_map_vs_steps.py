...
def plot_steps_map_updated():
    ...
    plt.annotate(
        ...
        xy=(4, 0.747),
        xytext=(1, 0.714),
        arrowprops=dict(arrowstyle="->", color="red", lw=2, linestyle=":", alpha=0.6),
    )
    plt.text(2.2, 0.735, "+3.3% Gain", color="red", fontweight="bold", rotation=20)

    plt.title(
        "Performance Gain in Few-step Regime", fontsize=20, fontweight="bold", pad=25
    )
