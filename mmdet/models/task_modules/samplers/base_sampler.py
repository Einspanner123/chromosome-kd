    ...
    def sample(
        ...
        **kwargs,
        ...
        Example:
            ...
            >>> pred_instances = InstanceData()
            >>> pred_instances.priors = random_boxes(
            ...     assign_result.num_preds, rng=rng
            ... )
            >>> gt_instances = InstanceData()
            >>> gt_instances.bboxes = random_boxes(
            ...     assign_result.num_gts, rng=rng
            ... )
        ...
        if self.add_gt_as_proposals and len(gt_bboxes) > 0:
            ...
            if isinstance(gt_bboxes, BaseBoxes) and isinstance(
                priors, BaseBoxes
            ):
