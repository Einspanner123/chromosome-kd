...
class CenterRegionAssigner(BaseAssigner):
    ...
    def assign(
        ...
        **kwargs,
        ...
        Example:
            ...
            >>> pred_instances.priors = torch.Tensor(
        ...
        if num_gts == 0 or num_priors == 0:
            ...
            assigned_gt_ids, pixels_in_gt_shadow = (
                self.assign_one_hot_gt_indices(
                    is_prior_in_gt_core,
                    is_prior_in_gt_shadow,
        ...
        if (
            gt_instances_ignore is not None
            ...
            is_prior_in_ignored_gts = is_located_in(
                prior_centers, gt_bboxes_ignore
            )
        ...
        assign_result.set_extra_property(
            'shadowed_labels', shadowed_pixel_labels
        )
    ...
    def assign_one_hot_gt_indices(
        ...
        matched_bbox_gt_inds = torch.nonzero(
            is_prior_in_gt_core, as_tuple=False
        )[:, 1]
