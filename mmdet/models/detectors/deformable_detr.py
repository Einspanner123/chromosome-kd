...
class DeformableDETR(DetectionTransformer):
    ...
    def _init_layers(self) -> None:
        ...
        if not self.as_two_stage:
            self.query_embedding = nn.Embedding(
                self.num_queries, self.embed_dims * 2
            )
    ...
    def init_weights(self) -> None:
        ...
        if self.as_two_stage:
            ...
            xavier_init(
                self.reference_points_fc, distribution='uniform', bias=0.0
            )
    ...
    def pre_decoder(
        ...
        if self.as_two_stage:
            ...
            # See https://github.com/open-mmlab/mmdetection/blob/master/mmdet/models/dense_heads/deformable_detr_head.py#L241
