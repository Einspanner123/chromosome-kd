...
class BBoxHead(BaseModule):
    ...
    def __init__(
        ...
        if self.with_reg:
            ...
            out_dim_reg = (
                box_dim if reg_class_agnostic else box_dim * num_classes
            )
    ...
    def refine_bboxes(
        ...
        Example:
            ...
            >>> sampling_results = [
            ...     SamplingResult.random(rng=10) for _ in range(n_img)
            ... ]
        ...
        labels = torch.where(
            labels == self.num_classes, cls_scores.argmax(1), labels
        )
