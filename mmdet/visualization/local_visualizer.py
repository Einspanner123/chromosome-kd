...
class DetLocalVisualizer(Visualizer):
    ...
    Examples:
        ...
        ... )
        >>> det_local_visualizer.add_datasample(
        ...     'image', image, gt_det_data_sample, out_file='out_file.jpg'
        ... )
        >>> det_local_visualizer.add_datasample(
        ...     'image', image, gt_det_data_sample, show=True
        ... )
        ...
        >>> det_local_visualizer.add_datasample(
        ...     'image', image, gt_det_data_sample, pred_det_data_sample
        ... )
    """
    ...
    def _draw_instances(
        ...
        if 'masks' in instances:
            ...
            max_label = int(max(labels) if len(labels) > 0 else 0)
            mask_color = (
                palette if self.mask_color is None else self.mask_color
            )
    ...
    def _draw_panoptic_seg(
        ...
        if 'label_names' in panoptic_seg:
            ...
            ignore_index = panoptic_seg.metainfo.get(
