...
seed42 已完成 12 epoch。`loss_quality` 从约 0.73 收敛至约 0.08--0.09，梯度有限；
epoch 3 首次达到 best mAP 0.752，epoch 8/11/12 再次达到 0.752。best checkpoint
来源为
`work_dirs/dlqcr_iou_survival_chr2024_seed42/best_coco_bbox_mAP_epoch_3.pth`，对应
