...
|------|---------|:---:|------|------|
| **IO1** 自适应步数终止 | 收敛后提前结束采样循环 | **证伪** | x0_Δrel 最低 0.166 (>>0.01 阈值), cls 一致率仅 65% | [IO1](../archived/自适应步数提前终止.md) |
| **IO2** 投机 Draft-Verify | 1步草稿+多步验证 | **证伪** | 早期步 cls 一致率 57%, draft 不可靠 | [IO2](../archived/投机Draft_Verify.md) |
