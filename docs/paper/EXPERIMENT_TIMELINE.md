...
> ⚠️ **暂时废弃**：以下 Phase 1-3 的结论基于旧数据集 Chromosome20240904（mAP≈0.72-0.75），24obj 数据集上的结论已更新（见文末"24obj 数据集补充"）。
...
> ⚠️ **暂时废弃**：以下叙事弧基于旧数据集 Chromosome20240904（mAP≈0.72-0.75），24obj 数据集上的结论已更新。
...
### LDMDet 主路线消融 A0-A4 / Mainline Ablation（项目 ldmdet-mainline-ablation-24obj）
...
### 耦合策略消融 / Coupling Strategy Ablation（24obj，3 seeds）
