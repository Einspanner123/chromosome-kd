...
解释。Dataset 1 的三套独立基座复现中，seed42/123 已分别由 0.746/0.748 提升至
0.751/0.753（均 +0.005）；seed789 在训练前两轮由 0.747 提升至 0.751（当前
+0.004）。完整训练和 ross 统一逐 IoU 复评结束前，均标为初步跨数据集证据。
