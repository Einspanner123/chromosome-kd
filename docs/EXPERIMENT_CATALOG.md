...
| `ldmdet-breakthrough` | 13 | Dataset 2/Dataset 1 | SC-RF 自条件化, I1 Seesaw Loss, 其他突破方向 |
...
| `chromosome-kd-ablation` | 8 | Dataset 1 | 早期消融 |
| `chromosome-kd-stability` | 7 | Dataset 1 | 早期稳定性实验 |
| `chromosome-kd-kcec` | 7 | Dataset 1 | KCCE 对比学习 |
| `chromosome-kd-dpm` | 6 | Dataset 1 | DPM-Solver 早期实验 |
| `chromosome-kd-smallobj` | 6 | Dataset 1 | 小目标尺度感知 |
| `chromosome-kd-multiseed` | 5 | Dataset 1 | 早期多种子 |
| `chromosome-kd-daec` | 2 | Dataset 1 | DAEC 对比学习 |
| `chromosome-kd-arch` | 2 | Dataset 1 | 架构探索 |
| `chromosome-kd-scheme-a` | 2 | Dataset 1 | 方案 A |
| `chromosome-gen` | 2 | Dataset 1 | 生成式实验 |
| `chromosome-kd-scheme-b` | 1 | Dataset 1 | 方案 B |
| `chromosome-kd-verify-v1` | 1 | Dataset 1 | 验证实验 v1 |
...
### 1.1 Dataset 2 数据集 — 核心实验 (论文引用)

| 实验名称 | 数据集 | SwanLab项目 | run_id | 本地路径 | 配置文件 | mAP | 状态 | 分类 |
|----------|--------|------------|--------|----------|----------|-----|------|------|
| DDPM baseline (Euler 1步) | Dataset 2 | ldmdet-mainline-ablation-24obj | (a0_baseline) | work_dirs/a0_baseline_24obj/ | a0_baseline_24obj.py | 0.774 | ✅ 完成 | 主路线消融 |
| RF+Heun | Dataset 2 | ldmdet-mainline-ablation-24obj | (a1_rf_heun) | work_dirs/a1_rf_heun_24obj/ | a1_rf_heun_24obj.py | 0.856 val (test: 0.857) | ✅ 完成 | 主路线消融 | <!-- 2026-07-26 test mAP=0.857 (Δ=+0.001) -->
| +AdaLN-Zero | Dataset 2 | ldmdet-mainline-ablation-24obj | (a2_rf_heun_adaln) | work_dirs/a2_rf_heun_adaln_24obj/ | a2_rf_heun_adaln_24obj.py | 0.856 val | ✅ 完成 | 主路线消融 |
| +Stoch. Coupling eps5 | Dataset 2 | ldmdet-mainline-ablation-24obj | (a3_full_sota) | work_dirs/a3_full_sota_24obj/ | a3_full_sota_24obj.py | 0.858 val (test: 0.858) | ✅ 完成 | 主路线消融 | <!-- 2026-07-26 test mAP=0.858 (Δ=0.000); 论文 Table 5/6 中 "+Stoch. Coupling" 对应此 checkpoint -->
| **+DPM-Solver++** | Dataset 2 | ldmdet-mainline-ablation-24obj | (a4_dpm_pp) | work_dirs/a4_dpm_pp_24obj/ | a4_dpm_pp_24obj.py | **0.863 val** (3-seed val: 0.859±0.003; **test: 0.859**) | ✅ 完成 | 主路线消融 | <!-- verified: 2026-07-16: seed42=0.863 val, seed123=0.857@ep62 val, seed789=0.856@ep72 val; 2026-07-26 test set mAP=0.859 (Δ=−0.004 vs val seed42 best, 唯一显著偏差; 见 §7.5 C4) -->
...
| Random seed_789 | Dataset 2 | ldmdet-ablation | r8n441mu4gws43xyoneoj | work_dirs/24obj_ablation/random/seed_789/ | chromo_24obj_random.py | 0.860 | ✅ 完成 | 耦合消融 |
| Random seed_123 | Dataset 2 | ldmdet-ablation | q6jgxefgxbp8f2sf5qzpc | work_dirs/24obj_ablation/random/seed_123/ | chromo_24obj_random.py | 0.860 (best@ep115) | ✅ 完成 (首跑中断 0.814@ep14, 重启后 EarlyStopping@ep145) | 耦合消融 | <!-- 2026-07-26 核实: 首跑 20260623_225843 中断@ep14, 重启 20260624_021224 完成, best 0.860@ep115; 3-seed 实际可用 0.859/0.860/0.860 -->
| GHSS seed_42 | Dataset 2 | ldmdet-ablation | k84cq9oftbp2nld88a85t | work_dirs/24obj_ablation/ghss/seed_42/ | chromo_24obj.py | 0.857 | ✅ 完成 | 耦合消融 |
| GHSS seed_789 | Dataset 2 | ldmdet-ablation | holadvhaz9v2rh8l494hv | work_dirs/24obj_ablation/ghss/seed_789/ | chromo_24obj.py | 0.859 | ✅ 完成 | 耦合消融 |
| GHSS seed_123 | Dataset 2 | ldmdet-ablation | 73cr3uyqw4f1q68xz1evg | work_dirs/24obj_ablation/ghss/seed_123/ | chromo_24obj.py | 0.859 | ✅ 完成 | 耦合消融 |
| Sinkhorn Stoch seed_42 | Dataset 2 | ldmdet-ablation | o96m1eqz4l12qjeyys1cs | work_dirs/24obj_ablation/sinkhorn/seed_42/ | chromo_24obj_sinkhorn.py | 0.856 | ✅ 完成 | 耦合消融 |
| ldmdet_stochot_eps5 (早期) | Dataset 2 | chromosome-kd-benchmark-24obj | odnz6a8pnda3gyg84cfqv | work_dirs/ldmdet_rf_heun_adaln_stochot_eps5/ | ldmdet_rf_heun_adaln_stochot_eps5.py | 0.853 | ✅ 完成 | 早期基线 |

### 1.2 Dataset 2 数据集 — 基线对比模型
...
### 1.3 Dataset 2 数据集 — 探索性实验 (未进论文/已归档)

| 实验名称 | SwanLab项目 | 本地路径 | 配置文件 | mAP | 状态 | 分类 |
|----------|------------|----------|----------|-----|------|------|
| +AdaLN-Zero +SwiGLU FFN | ldmdet-mainline-ablation-24obj | work_dirs/a2_swinglu_24obj/ | a2_swinglu_24obj.py (备份) | 0.859 | ✅/⚠ | 探索-激活函数 | <!-- verified: 2026-07-16 -->
| +DPM-Solver++ +SwiGLU FFN | ldmdet-mainline-ablation-24obj | work_dirs/a4_swinglu_24obj/ | a4_swinglu_24obj.py (备份) | 0.857 | ✅/⚠ | 探索-激活函数 | <!-- verified: 2026-07-16 -->
...
| Cascade Head Count e2e | ldmdet-frontier-directions | — | — | 0.684 | ✅ FINISHED | 前沿方向(证伪) |
...
|----------|------------|--------|----------|-----|------|------|
| DDPM seed_42 | ldmdet-ablation | apfn46t67iqg1bjraq8xd | work_dirs/multi_seed_aug/ddpm/seed_42/ | 0.726 | ✅ | Dataset 1 基线 |
| DDPM seed_789 | ldmdet-ablation | hny1od5fcvx8ngt9b063g | work_dirs/multi_seed_aug/ddpm/seed_789/ | 0.727 | ✅ | Dataset 1 基线 |
| DDPM seed_123 | ldmdet-ablation | ghghjry3bylt0sfoj30j5 | work_dirs/multi_seed_aug/ddpm/seed_123/ | 0.733 | ✅ | Dataset 1 基线 |
| RF+Heun+AdaLN seed_42 | ldmdet-ablation | 4xhp5ffymboa05hyn245u | work_dirs/multi_seed_aug/rf_heun_adaln/seed_42/ | 0.745 | ✅ | Dataset 1 基线 |
| RF+Heun+AdaLN seed_789 | ldmdet-ablation | ww6nlti3ufdkm4htjg5pw | work_dirs/multi_seed_aug/rf_heun_adaln/seed_789/ | 0.747 | ✅ | Dataset 1 基线 |
...
| **+DPM-Solver++ (trained) seed_42** | ldmdet-mainline-ablation-24obj (注: D1 实验) | — | work_dirs/a4_dpm_pp_chr2024_seed42/ | 0.746 @ ep49 | ✅ 完成 (early stop @ ep50, patience=30) | Dataset 1 主路线 (3-seed: 0.747±0.001) | <!-- 2026-07-30 新增: +DPM-Solver++ 在 D1 上训练, seed42 best@ep49, 配置 a4_dpm_pp_chr2024.py, ross A6000; 2026-07-31 更新 3-seed mean (seed789 重训完成 0.746@ep72) -->
...
| **+DPM-Solver++ (trained) seed_789** | ldmdet-mainline-ablation-24obj (注: D1 实验) | — | work_dirs/a4_dpm_pp_chr2024_seed789/ | 0.746 @ ep72 | ✅ 完成 (early stop @ ep102, patience=30; 重训修正: 旧 run 0.724@ep22 异常偏低已确认, 2026-07-30 17:34 本地重训 → 2026-07-31 03:13 完成, best 0.746@ep72 接近 seed42=0.746/seed123=0.748) | Dataset 1 主路线 (3-seed: 0.747±0.001) | <!-- 2026-07-30 重训→2026-07-31 03:13 完成: 旧 run 0.724@ep22 异常偏低已确认, 重训 best 0.746@ep72 early stop@ep102; 3-seed mean 0.747±0.001 (seed42=0.746/seed123=0.748/seed789=0.746) -->
...
| SOTA seed_456 | chromosome-kd | ukxsyw666y1xrpcrtjvx1 | work_dirs/sota_seed456/ | 0.746 | ✅ | Dataset 1 SOTA |
| SOTA seed_1000 | chromosome-kd | ocdkvjs2vs1vozbh0goni | work_dirs/sota_seed1000/ | 0.749 | ✅ | Dataset 1 SOTA |
| OT + ScaleConditionedRF 非线性轨迹 (OLD) | ldmdet-ablation | usnvd63f | work_dirs/nonlinear_trajectory/ | 0.752 | ✅ 早停 | 非线性(证伪) |
| OT + ScaleConditionedRF eps2 (OLD, SCRF未启用) | ldmdet-ablation | cdtmijl0 | work_dirs/nonlinear_trajectory_e43_eps2/ | 0.752 | ✅ 早停 | 非线性(证伪) |
| OT + ScaleConditionedRF eps2 (NEW, SCRF启用) | ldmdet-ablation | hkn0fc7w | work_dirs/nonlinear_trajectory_e43_eps2_real/ | 0.741 | ✅ 早停 | 非线性(证伪) |
| OT Flow Coupling only | ldmdet-ablation | wcp34v3t | work_dirs/nonlinear_trajectory_e42/ | 0.751 | ✅ 早停 | 非线性 |
| ScaleConditionedRF only (无OT) | ldmdet-ablation | qdnw5yyj | work_dirs/nonlinear_trajectory_e41/ | 0.743 | ✅ 早停 | 非线性 |
| Box Refine Net | ldmdet-ablation | fnoz9x82aor1utsuo0jtl | work_dirs/direction_exps/direction_d_box_refine/ | 0.747 | ✅ 早停 | 方向实验 |
| Decoupled Head | ldmdet-ablation | 2ckzmso4c94fojr8jobej | work_dirs/direction_exps/direction_b_decoupled_head/ | 0.749 (max@step74) / 0.702@step25 | ⚠ 实际未中断 (86 evals) | 方向实验(需复核) | <!-- verified: 2026-07-16 -->
| FBM variant (frozen) | ldmdet-ablation | qyzudrgb | work_dirs/gen_transfer_phase1_e6_2_frozen/ | 0.737 | ✅ 已停止 | 生成迁移(证伪) |
| FBM variant (enhanced) | ldmdet-ablation | m2fyzmf9 | work_dirs/gen_transfer_phase1_e6_3_enhanced/ | 0.703 | ✅ 已停止 | 生成迁移(证伪) |
| FBM variant (frozen+enhanced) | ldmdet-ablation | bbe2yrcg | work_dirs/gen_transfer_phase1_e6_3b_frozen_enhanced/ | 0.696 | ✅ 已停止 | 生成迁移(证伪) |
| FBM variant (crossattn) | ldmdet-ablation | x8j5l7mw | work_dirs/gen_transfer_phase1_e6_4_crossattn/ | 0.733 | ✅ 已停止 | 生成迁移(证伪) |
| OT + ScaleConditionedRF eps3 | ldmdet-ablation | 5m1lse6x | work_dirs/nonlinear_trajectory_e43_eps3/ | 0.750 | ✅ 早停 | 非线性 |
| OT + ScaleConditionedRF multinomial | ldmdet-ablation | l0991c8v | work_dirs/nonlinear_trajectory_e43_multinomial/ | 0.748 | ✅ 早停 | 非线性 |
...
| Reg Calibration | ldmdet-ablation | — | work_dirs/direction_exps/direction_d_prime_reg_calibration/ | 0.737 | ✅ 早停 | 方向实验 |
| Decoupled Box Refine | ldmdet-ablation | — | work_dirs/direction_exps/direction_db_decoupled_box_refine/ | 0.743 | ✅ 早停 | 方向实验 |
| Class-Balanced Sampling | ldmdet-ablation | — | work_dirs/direction_exps/direction_e_class_balanced/ | 0.746 | ✅ 早停 | 方向实验 |
...
| YOLOX-S (Dataset 1) | chromosome-kd-benchmark | — | work_dirs/baselines/yolox_s_20240904/ | 0.589 @ ep150 | ✅ | Dataset 1 标准检测器 | <!-- 2026-07-31 数据库校准修正: 原值 0.608 来自首次训练 (20260519), best checkpoint 时间戳 (May 20 12:44) 对应第二次训练 (20260520) 的 0.589; 两次同 seed (1769925607) 训练结果不同 (CUDA 非确定性), 以当前 best checkpoint 为准 -->
| DINO R50 (Dataset 1) | chromosome-kd-benchmark | dino-r50-4scale-20240904 | work_dirs/baselines/dino_r50_20240904/ | 0.742 @ ep~77 | ✅ 完成 (early stop @ ep107, best@ep~77, max_epoch=150) | Dataset 1 标准检测器 | <!-- 2026-07-30: 训练完成, early stop patience=30 触发; best mAP=0.742; 之前 2026-07-29 标注 0.607@ep29 为 31ep 未完成时的中间值; 配置 work_dirs/baselines/dino_r50_20240904/dino_r50.py; 训练日志 work_dirs/baselines/dino_r50_20240904/20260730_015633/20260730_015633.log; ross A6000 -->
...
#### 2.1.1 主路线消融 DDPM baseline → +DPM-Solver++ (项目 `ldmdet-mainline-ablation-24obj`, ⭐ 论文核心)

| 实验 | mAP | AP50 | AP75 | APs | APm | APl | ΔmAP | 说明 |
|------|-----|------|------|-----|-----|-----|------|------|
| DDPM baseline (Euler 1步, 无RF) | 0.774 | 0.968 | 0.916 | 0.317 | 0.773 | 0.775 | — | 基线 |
| RF+Heun | 0.856 | 0.990 | 0.971 | 0.563 | 0.853 | 0.913 | **+0.082** | 主要贡献 |
| +AdaLN-Zero | 0.856 | 0.990 | 0.972 | 0.565 | 0.853 | 0.919 | +0.000 | 持平 RF+Heun |
| +Stoch. Coupling eps5 | 0.858 | 0.990 | 0.973 | 0.586 | 0.855 | 0.908 | +0.002 | 边际 |
| +DPM-Solver++替换Heun | **0.863** | 0.990 | 0.974 | 0.583 | 0.859 | 0.914 | +0.005 | 推理加速且精度提升 |

> 数据来源: `results/swanlab_export.json` (SwanLab API 导出, 2026-07-15)
> ⚠ 命名历史: 论文 (AAAI 草稿) 原使用 A0-A3 代号 (DDPM baseline / RF+Heun+AdaLN 合并 / +Stoch. Coupling / +DPM-Solver++), 本目录原使用 A0-A4 五级映射 (AdaLN-Zero 独立)。2026-07-27 命名统一后全文改用描述性名称, 代号仅保留在文件路径/SwanLab run_id 中。详见 §5 数据完整性 C4。
...
> 核心发现: Dataset 2 上 Random ≥ GHSS ≥ Sinkhorn Stochastic, OT 耦合优势在大数据集下减弱。

#### 2.1.3 其他实验性尝试 (Dataset 2)

| 实验 | mAP | Δ vs +Stoch. Coupling(0.858) | 状态 | 说明 |
|------|-----|----------------|------|------|
| SC-RF (自条件化RF) | 0.860 | +0.002 | ✅ 已归档 | **超越 +Stoch. Coupling**, 但 vs +DPM-Solver++(0.863) 仍为 -0.003 负增益; 已于 2026-07-11 归档 | <!-- verified: 2026-07-16: 本地 scalars.json max=0.860 (count=112, best@ep82) -->
| h_velocity_loss | 0.856 | -0.002 | ⚠ CRASHED | 速度损失 |
| Cascade Head Count e2e | 0.684 | -0.174 | ✅ FINISHED | 端到端级联, 显著退化 (证伪) |
| FBM CrossAttn (源预训练) | 0.857 | -0.001 | ⚠ CRASHED | 与 +Stoch. Coupling 持平 |
| FBM SimpleGate (源预训练) | 0.677 | -0.181 | ❌ 已停止 | 严重退化 |
| +AdaLN-Zero +SwiGLU | 0.859 | +0.001 | ✅/⚠ | FFN 激活函数替换 (新增) | <!-- verified: 2026-07-16: 本地 scalars.json max=0.859 (count=76) -->
| DPM-Solver++ +SwiGLU | 0.857 | -0.001 | ✅/⚠ | FFN 激活函数替换 (新增) | <!-- verified: 2026-07-16: 本地 scalars.json max=0.857 (count=66) -->
...
| I1 Seesaw+Normalized | 0.744 | — | ✅/⚠ | ⚠ 实为 Dataset 1 数据集 (非 Dataset 2), 误列入本节 | <!-- verified: 2026-07-16 -->

#### 2.1.4 Dataset 2 Solver×Step 解耦推理 (DPM-Solver++ checkpoint, 项目 `ldmdet-inference`)

> 数据来源: 2026-07-15 在 +DPM-Solver++ 训练的 checkpoint (`best_coco_bbox_mAP_epoch_117.pth`, seed 42) 上, 通过覆盖推理 solver 和步数进行的受控对比。所有实验在 Dataset 2 val (500 images) 上评估。论文 §4.5 Solver Analysis 直接引用本表数据。
...
> ⚠ **Stoch. Coupling ε=5 数据源差异说明**: 论文 §4.4.3 epsilon 消融 (ε=0.5→0.710, ε=1.0→0.745, ε=2.0 stochastic→0.749, ε=5.0→0.746, ε=2.0 argmax→0.752) 与 EXPERIMENT_RESULTS.md §5 旧值 (0.720-0.738) 不匹配, 可能来自不同实验批次 (nonlinear_trajectory 系列)。本地仅 seed_42=0.748 可直接验证。详见 §5 C15/C16。 <!-- verified: 2026-07-16 -->

#### 2.2.2 非线性轨迹实验 (Dataset 1, 证伪)

| 实验 | mAP | Δ vs 0.746 | 说明 |
|------|-----|-----------|------|
| ScaleConditionedRF only (无OT) | 0.743 | -0.003 | 持平 |
| OT Flow Coupling only | 0.751 | +0.005 | OT 耦合有效 |
| OT + ScaleConditionedRF (SCRF未启用) | 0.752 | +0.006 | 实际来自 OT, 非 SCRF |
| **OT + ScaleConditionedRF eps2 (SCRF真正启用)** | **0.741** | **-0.005** | ⛔ 证伪! SCRF 有害 |
| OT + ScaleConditionedRF eps3 (argmax, ε=3.0) | 0.750 | +0.004 | OT 耦合有效 (LINEAGE: 5m1lse6x, best@ep70) |
| OT + ScaleConditionedRF multinomial (multinomial采样) | 0.748 | +0.002 | OT 耦合有效 (LINEAGE: l0991c8v, best@ep72) |
...
#### 2.2.3 方向实验 / 生成迁移 / Bottleneck (Dataset 1)

| 实验 | mAP | Δ vs 0.746 | 说明 |
|------|-----|-----------|------|
| Box Refine Net | 0.747 | +0.001 | 持平 |
| Decoupled Head | 0.749 (max) / 0.702@step25 | +0.003 / -0.044 | ⚠ 需复核 (训练未中断, 86 evals; 原文档误记 0.702 为最终值) | <!-- verified: 2026-07-16 -->
| Reg Calibration | 0.737 | -0.009 | 🔴 未超越 baseline (local: direction_d_prime_reg_calibration) |
| Decoupled Box Refine | 0.743 | -0.003 | 持平 (local: direction_db_decoupled_box_refine) |
| Class-Balanced Sampling | 0.746 | +0.000 | 持平 (local: direction_e_class_balanced) |
| Structured Prior Only | 0.685 | -0.061 | ⛔ 显著退化 (local: direction_f_prime_structured_prior_only, 仅 29 evals) |
| Structured Prior Head | 0.574 | -0.172 | ⛔ 严重退化 (local: direction_f_structured_prior) |
| LaMFPN | 0.736 | -0.010 | 🔴 未超越 baseline (local: direction_g_lamfpn) |
...
| FBM variant (frozen) | 0.737 | -0.009 | 🔴 未超越 baseline |
| FBM variant (enhanced) | 0.703 | -0.043 | 🔴 显著退化 (LINEAGE: m2fyzmf9, best@ep19) |
| FBM variant (frozen+enhanced) | 0.696 | -0.050 | 🔴 显著退化 (LINEAGE: bbe2yrcg, best@ep16) |
| FBM variant (crossattn) | 0.733 | -0.013 | 🔴 gamma 零初始化失效 | <!-- verified: 2026-07-16 -->

#### 2.2.4 Reflow 退化陷阱 (Dataset 1, 论文 §4.7)
...
#### 2.2.5 Step-wise 推理效率对比 (Dataset 1, 论文 §4.2.3)
...
#### 2.2.6 历史 SOTA 归档实验 (Dataset 1, ldmdet-experiment)
...
| YOLOX-S | CSPDarkNet-S | **0.589** | 0.924 | 0.704 | 0.359 | 0.587 | 0.487 | 150 | ✅ |
...
> - YOLOX-S: Dataset 1 **0.589** vs Dataset 2 **0.796** (Δ=−0.207, 退化 26.0%)
> - DINO R50: Dataset 1 **0.742** (✅ 完成) vs Dataset 2 **0.868** (Δ=−0.126, 退化 14.5%) — 退化幅度与 RTMDet-L/Cascade R-CNN 相当, 不再是退化最严重者 (YOLOX-S 26.0% 退化最显著); 之前标注的 Δ=−0.261/退化 30.1% 基于 31ep 未完成的 0.607, 已修正
>
> 对比 KaryoFlow (RF+Heun+AdaLN) 在 Dataset 1 上 3-seed 均值 **0.746** (论文 §4.1): KaryoFlow 在低数据场景下超越 Cascade R-CNN (0.732) / YOLOX-S (0.589), 与 RTMDet-L (0.742) / DINO R50 (0.742) 持平 (Δ=+0.004, 在 noise 范围内), 支撑论文 "基于扩散的检测器在数据稀缺场景下达到与前沿检测器相当的精度" 的核心论点。注: DINO R50 已完成 150ep 训练 (early stop @ ep107), 0.742 为完全收敛后的最终 best, 不再是未完成中间值; DETR 类大模型对数据量依赖的论点需修订 (DINO R50 D1→D2 退化 14.5%, 与 RTMDet-L 14.0% 同量级)。
>
> 训练配置: `experiments/configs/baselines/benchmark/{cascade_rcnn_r50,rtmdet_l,yolox_s,dino_r50}.py` (data_root=`data/Chromosome20240904_NoAug_NoResize_coco/`)。<!-- verified: 2026-07-29; 2026-07-30 DINO R50 完成训练, mAP 0.607→0.742 -->
...
> **命名统一说明**: 本目录已与论文命名统一 (DDPM baseline / RF+Heun / +AdaLN-Zero / +Stoch. Coupling / +DPM-Solver++)。内部实验代号 (A0-A4) 仅保留在文件路径、配置名和 SwanLab run_id 中。原映射表已删除 (2026-07-27)。
...
|------|------|----------|------------|------|
| SetDiff baseline (Dataset 2) | setdiff_24obj.py | work_dirs/setdiff_24obj/ | setdiff-24obj | ✅/⚠ (早期, 仅 7 evals, max mAP=0) | <!-- verified: 2026-07-16 -->
| SetDiff baseline (Dataset 1) | setdiff_baseline.py | — | — | — |
...
| 实验 | 配置 | 本地路径 | mAP | 状态 |
|------|------|----------|-----|------|
| PD-RF Dataset 2 | pd_rf_24obj.py (备份) | work_dirs/pd_rf_24obj/ | 0.851 | ⛔ 证伪 (2026-07-11 归档) | <!-- verified: 2026-07-16: 本地 scalars.json max=0.851 (count=31) -->
...
| velocity_loss | 速度损失 | ⚠ CRASHED (Dataset 2) |
...
| 实验 | mAP | 状态 | 说明 |
|------|-----|------|------|
| Decoupled Head | 0.749 (max) / 0.702@step25 | ⚠ 需复核 | 解耦头 max 超过 baseline, 原结论需复核 | <!-- verified: 2026-07-16 -->
| Box Refine Net | 0.747 | ✅ 持平 | 框精修无提升 |
| FBM variants (生成迁移) | 0.696-0.737 | ⛔ 证伪 | FBM 均未超越 baseline |
| Cascade Head Count e2e | 0.684 | ⛔ 证伪 | 端到端级联失败 |
| DINOv2-S backbone | 0.502-0.676 | ⛔ 证伪 | DINOv2 全失败 |
| BiFPN (scheme_E) | 0.744 | ⛔ 未采用 | BiFPN 无提升 |
| CSPNeXt-L backbone | 0.730 | ⛔ 证伪 | CSPNeXt 退化 |
| I1 Seesaw+Normalized | 0.744 | ✅/⚠ | 长尾类别平衡 (⚠ Dataset 1 数据集, 非 Dataset 2) | <!-- verified: 2026-07-16 -->
| SwiGLU FFN (+AdaLN-Zero/DPM-Solver++) | 0.859 / 0.857 | ✅/⚠ | 门控激活函数 (+AdaLN-Zero=0.859 +0.001, DPM-Solver++=0.857 -0.001) | <!-- verified: 2026-07-16 -->
| PD-RF 渐进蒸馏 | 0.851 | ⛔ 证伪 | 渐进蒸馏 4→1 失败, 2026-07-11 归档 | <!-- verified: 2026-07-16 -->
| Adaptive Step (自适应步数终止) | — | ⛔ 证伪 | x0_Δrel 最低 0.166 |
| Draft-Verify (投机) | — | ⛔ 证伪 | 早期步 cls 一致率 57% |
| Head Early-Exit (级联头提前退出) | — | ⛔ 证伪 | 所有阈值退出率 0% |
| RoI Feature Cache (跨步 RoI 特征缓存) | — | ⛔ 证伪 | 框位移 93-124 px/步 |

### 3.3 基线对比实验 (Dataset 2)
...
| **+DPM-Solver++ (本文)** | ResNet-50 | **0.863** | 0.990 | 0.974 | ✅ | ldmdet-mainline-ablation-24obj |
| +Stoch. Coupling Heun (本文) | ResNet-50 | 0.858 | 0.990 | 0.973 | ✅ | ldmdet-mainline-ablation-24obj |
...
|------|--------|------------|------|------|
| DPM-Solver++ seed_123 | workstation | ldmdet-mainline-ablation-24obj | **0.857** @ ep62 | DPM-Solver++ 多种子 ✅ 完成 (3-seed: 0.863/0.857/0.856, mean 0.859±0.003) |
| DPM-Solver++ seed_789 | workstation | ldmdet-mainline-ablation-24obj | **0.856** @ ep72 | DPM-Solver++ 多种子 ✅ 完成 |
| Stoch. Coupling ε=5 seed_123 (old) | ross | ldmdet-ablation | **0.746** @ ep57 | Stoch. Coupling 多种子 ✅ 完成 (3-seed: 0.746/0.746/0.749, mean 0.747±0.002) |
| Stoch. Coupling ε=5 seed_789 (old) | ross | ldmdet-ablation | **0.749** @ ep69 | Stoch. Coupling 多种子 ✅ 完成 |
| Stoch. Coupling ε=2 seed_42 (old) | workstation | ldmdet-ablation | **0.749** @ ep75 | ε 消融补充 ✅ 完成 |

> ⚠ SC-RF Dataset 2 已于 2026-07-11 归档 (max mAP=0.860), 不再运行。+DPM-Solver+++SwiGLU 已完成 (0.857)。详见 §2.1.3。 <!-- verified: 2026-07-16 -->
> ✅ 所有多种子补充实验已完成。workstation 上的 checkpoint 待 SCP 到 ross (workstation 连接问题搁置)。

### 3.5 SwanLab 同步补充实验 (2026-07-19)

> 数据来源: SwanLab `ldmdet-mainline-ablation-24obj` 项目 (2026-07-19 通过 `swanlab.OpenApi` 拉取)。本节补充 §3.4 之后新增的 DDPM baseline/RF+Heun 多种子与 RF+Heun shift 消融实验, 所有 mAP/AP50/AP75 均为 SwanLab 记录的 max 值 (3 位小数)。

#### 3.5.1 DDPM baseline 多种子 (Dataset 2)

| 实验 | run_id | mAP | AP50 | AP75 | 状态 | eval 次数 |
|------|--------|-----|------|------|------|----------|
| DDPM baseline seed_42 (main) | qr93hfz65u99m1m7psmb8 | 0.774 | 0.968 | 0.916 | ✅ FINISHED | 12 |
| DDPM baseline seed_123 | lvjqwpa44qnyza0odwth9 | 0.753 | 0.966 | 0.909 | ✅ FINISHED | 12 |
| DDPM baseline seed_789 | gfy4wt6l1onz8yakfbhf1 | 0.774 | 0.967 | 0.919 | ✅ FINISHED | 12 |

> DDPM baseline 3-seed: mean=0.767, std=0.012 (sample std, n-1)。⚠ DDPM baseline 仅 12 个 eval (DDPM 基线, 训练慢), 且 seed_123 明显偏低 (-0.021), 反映 DDPM 1-step 基线对初始化敏感。<!-- verified: 2026-07-19 SwanLab -->

#### 3.5.2 RF+Heun 多种子 (Dataset 2, rf_schedule=shifted, rf_shift=3)

| 实验 | run_id | mAP | AP50 | AP75 | 状态 | eval 次数 |
|------|--------|-----|------|------|------|----------|
| RF+Heun seed_42 (main) | pe6ljc6zlobcs744wcm8q | 0.856 | 0.990 | 0.971 | ✅ FINISHED | 92 |
| RF+Heun seed_123 | 42dbc2wwimx5hf69g2ktx | 0.857 | 0.990 | 0.970 | ✅ FINISHED | 95 |
| RF+Heun seed_789 | zbnloib75zw0t3ab13hsq | 0.852 | 0.987 | 0.968 | ✅ FINISHED | 67 |

> RF+Heun 3-seed: mean=0.855, std=0.003 (sample std)。seed_789 已完成 (EarlyStopping@ep67, best mAP=0.852@ep37, 2026-07-20 完成)。RF+Heun 多种子稳定性显著优于 DDPM baseline (std 0.003 vs 0.012), 与 +DPM-Solver++ (std=0.004) 同量级, 验证 RF+Heun 显著降低初始化敏感性。<!-- verified: 2026-07-26: 本地 scalars.json + 训练日志确认 EarlyStopping@ep67, best@ep37; 原 2026-07-19 SwanLab 标注 RUNNING 为过期状态 -->

#### 3.5.3 RF+Heun rf_schedule / rf_shift 消融 (Dataset 2, seed_42)

| 实验 | run_id | rf_schedule | rf_shift | mAP | AP50 | AP75 | 状态 | eval 次数 |
|------|--------|-------------|----------|-----|------|------|------|----------|
| RF+Heun unshifted | pzuchxux4va4e3c4yik3q | linear | 1 | 0.857 | 0.990 | 0.971 | ✅ FINISHED | 119 |
| RF+Heun shift2 | 8mbmjdvb798m3uquq7m73 | shifted | 2 | **0.860** | 0.990 | 0.972 | ✅ FINISHED | 105 |
| RF+Heun shift3 (main) | pe6ljc6zlobcs744wcm8q | shifted | 3 | 0.856 | 0.990 | 0.971 | ✅ FINISHED | 92 |
| RF+Heun shift5 | iuki2dyqjrtnx49rz3u4j | shifted | 5 | 0.856 | 0.990 | 0.971 | ✅ FINISHED | 104 |

> **结论**: shift 参数对 mAP 影响可忽略 (range 0.856-0.860, max-min=0.004, 在种子噪声范围内)。unshifted (linear, shift=1) 与 shift3 (main) 持平 (0.857 vs 0.856), shift2 略优 (+0.004) 但仍在噪声范围。论文中 rf_shift=3 的选择基于经验, 本消融支持 "shift 参数非关键超参" 的论断, 与 §七 C 类推理任务中 Top-K 剪枝的鲁棒性结论一致。<!-- verified: 2026-07-19 SwanLab -->

#### 3.5.4 同步汇总

- 本批次新增 7 个论文相关实验 (DDPM baseline 多种子 ×2 + RF+Heun 多种子 ×2 + RF+Heun shift 消融 ×3), 全部来自 `ldmdet-mainline-ablation-24obj` 项目。
- DDPM baseline/RF+Heun 多种子补齐了 §3.4 中 +DPM-Solver++ 多种子的对照, 现已具备 DDPM baseline/RF+Heun/+DPM-Solver++ 三组 3-seed 稳定性数据 (RF+Heun seed_789 已于 2026-07-20 完成, 见 §3.5.2)。+AdaLN-Zero (paper) 多种子补充进行中 (§3.7)。
- RF+Heun shift 消融验证 rf_shift 非关键超参, 支持论文中默认 rf_shift=3 的合理性。
- 跳过的项目: `ldmdet-inference` (108 个, 已归档至 §七)、`ldmdet-inference-opt-24obj` (4 个, 反向优化已回退)、`ldmdet-sota-stack` (3 个, Dataset 1 数据集)、`ldmdet-frontier-directions-24obj` (5 个, 全部 CRASHED)、`setdiff-24obj` (18 个, 全部 mAP=0, 见 §3.2.1)、`chromosome-kd-*` 早期项目 (与 Dataset 2 主线无关)。

### 3.6 SwanLab 补充同步 (第二轮, 2026-07-19)

> 数据来源: 2026-07-19 通过 `swanlab.Api` 拉取 21 个 SwanLab 项目的 40 个论文相关 run (含完整 mAP/AP50/AP75/APs/APm/APl 指标)。本节补充 §3.5 之外的剩余论文相关实验, 涵盖 Stoch. Coupling ε 消融数据源澄清、DPM-Solver++ Dataset 1 数据源、SOTA 多种子项目归属修正、Adaptive Step/Top-K/Head Early-Exit 训练、PD-RF v2/v3/v4 蒸馏变体、Q1 occlusion、Dataset 1 稳定性等。所有 mAP/AP50/AP75 均为 SwanLab 记录的 max 值 (3 位小数); APs/APm/APl 为小/中/大目标 COCO AP (3 位小数)。
...
|------|--------|---|-----|------|------|-----|-----|-----|------|----------|-----------|
| Stoch. Coupling ε=1 Dataset 1 | v97i4rtnkdkagko469w2s | 1 | 0.745 | 0.942 | 0.835 | 0.503 | 0.738 | 0.664 | ⚠ CRASHED | 63 | 38 |
| Stoch. Coupling ε=2 Dataset 1 | zs8sbypvh2d3rqtc6316o | 2 | 0.749 | 0.946 | 0.843 | 0.526 | 0.741 | 0.663 | ✅ FINISHED | 105 | 75 |
| Stoch. Coupling ε=5 seed_42 Dataset 1 | cgub615jprtse2g1edtcw | 5 | 0.746 | 0.946 | 0.833 | 0.511 | 0.740 | 0.659 | ⚠ CRASHED | 82 | 60 |
...
#### 3.6.2 DPM-Solver++ Dataset 1 历史数据源 (项目 `chromosome-kd-dpm`, §2.2.6 来源)
...
#### 3.6.4 Dataset 1 早期 ε 消融完整表 (项目 `chromosome-kd-ablation`, AdaLN 对照)

> 本项目为 2026-05-17 至 2026-05-23 期间在 Dataset 1 数据集上进行的 ε 消融完整对照 (AdaLN vs no-AdaLN × ε=1/2/5), 共 8 个实验, 全部使用 seed=1769925607, bs=8。

| 实验 | run_id | 配置 | mAP | AP50 | AP75 | APs | APm | APl | 状态 | best@step |
|------|--------|------|-----|------|------|-----|-----|-----|------|-----------|
| adaln only (no Stoch. Coupling) | sz03p2gl0367tfs8atx1x | RF+Heun+Shifted+AdaLN | 0.728 | 0.930 | 0.810 | 0.503 | 0.720 | 0.647 | ✅ FINISHED | 91 |
| ε=1 (no AdaLN) | 64oidkd7h8faes2ui5sj0 | RF+Heun+Shifted+Stoch. Coupling(ε=1) | 0.729 | 0.933 | 0.818 | 0.512 | 0.720 | 0.644 | ✅ FINISHED | 90 |
| ε=2 (no AdaLN) | 5uogugisz4ypsr14lg1m0 | RF+Heun+Shifted+Stoch. Coupling(ε=2) | 0.721 | 0.929 | 0.811 | 0.484 | 0.714 | 0.649 | ✅ FINISHED | 59 |
| ε=5 (no AdaLN) | 23ivqwwkskxb2i448l5zt | RF+Heun+Shifted+Stoch. Coupling(ε=5) | 0.720 | 0.926 | 0.810 | 0.473 | 0.713 | 0.637 | ⚠ CRASHED | 59 |
| AdaLN+ε=1 | j8ilij1d2lt8jsw34enxf | RF+Heun+Shifted+AdaLN+Stoch. Coupling(ε=1) | 0.735 | 0.934 | 0.822 | 0.501 | 0.727 | 0.640 | ✅ FINISHED | 76 |
| AdaLN+ε=2 | n3x4pxmig5h8nig3ps5js | RF+Heun+Shifted+AdaLN+Stoch. Coupling(ε=2) | **0.738** | 0.935 | 0.825 | 0.501 | 0.728 | 0.680 | ✅ FINISHED | 106 |
| AdaLN+ε=5 | 0t95a0gutx6yrqow1hpz5 | RF+Heun+Shifted+AdaLN+Stoch. Coupling(ε=5) | 0.734 | 0.934 | 0.820 | 0.505 | 0.728 | 0.665 | ✅ FINISHED | 90 |
| sota_group_hier_stoch | t7blsv2hs0zyfsiszz2bn | +AdaLN+Stoch. Coupling(ε=5)+GroupHier | 0.741 | 0.940 | 0.830 | 0.501 | 0.732 | 0.669 | ✅ FINISHED | 40 |

> **结论**:
> 1. **AdaLN-Zero 增益**: AdaLN+ε=2 (0.738) > ε=2 no-AdaLN (0.721), +0.017 增益; AdaLN+ε=5 (0.734) > ε=5 no-AdaLN (0.720), +0.014 增益。AdaLN-Zero 在 Dataset 1 数据集上稳定提升约 +0.014~0.017, 与论文 §4.3 AdaLN-Zero 消融结论方向一致 (但 Dataset 1 结论已废弃)。
...
> 3. **GroupHier 附加**: sota_group_hier_stoch (0.741) > AdaLN+ε=5 (0.734), +0.007, GroupHier 在 Dataset 1 上有小幅增益 (但未在 Dataset 2 验证)。
>
...
#### 3.6.5 Adaptive Step/Top-K/Head Early-Exit 训练运行 (项目 `ldmdet-inference-opt-24obj`)

> 本项目共 4 个实验, 包含 §七 C 类推理任务的训练侧对应实验。所有实验基于 `a3_full_sota_24obj.py` 配置, bs=2, 150ep。

| 实验 | run_id | 配置 | mAP | AP50 | AP75 | APs | APm | APl | 状态 | best@step |
|------|--------|------|-----|------|------|-----|-----|-----|------|-----------|
| Adaptive Step (step_early_exit) | hsgk86tf04rfyw8osj450 | 自适应步数提前终止 (thr=0.01, cls=0.95, min=1) | **0.860** | 0.990 | 0.972 | 0.553 | 0.857 | 0.911 | ✅ FINISHED | 83 |
| Top-K (K=100) topk_pruning | uo88by3p04s64gvevnecw | Top-K 框剪枝 (K=100, step0 后剪枝) | 0.823 | 0.960 | 0.935 | 0.492 | 0.820 | 0.879 | ✅ FINISHED | 31 |
| Head Early-Exit (head_early_exit) | 2avz2bdtbygoobld86w0m | 级联头提前退出 (min=3, box=0.005, cls=0.98, time_aware) | 0.859 | 0.990 | 0.971 | 0.575 | 0.856 | 0.913 | ✅ FINISHED | 85 |

> **关键发现**:
> 1. **Adaptive Step (step_early_exit) 训练 mAP=0.860** 与 +DPM-Solver++ (0.863) 接近 (-0.003), 但需配合推理时 Adaptive Step 评估才能验证自适应步数是否真正减少 NFE。该项目仅记录训练曲线, 推理结果在 §七 C 类任务归档中。
> 2. **Top-K (K=100) topk_pruning 训练 mAP=0.823** 显著低于 +Stoch. Coupling baseline (0.858), -0.035。与 §七 C 类推理任务 Top-K 剪枝结论一致 (K=100 训练即退化, 不只是推理退化)。论文应明确: Top-K 剪枝在训练阶段已引入 mAP 损失, K=200/300 是可接受范围。
> 3. **Head Early-Exit (head_early_exit) 训练 mAP=0.859** 与 +Stoch. Coupling (0.858) 持平 (+0.001), 表明级联头提前退出训练策略本身不引入精度损失, 推理收益完全来自 cascade head 跳过。
>
...
|------|--------|------|-----|------|-----------|------|
| PD-RF v2 | kybbfmpivf2iseq8wiunh | load_from +DPM-Solver++ + cascade_detach=False + cls蒸馏 | 0.860 | ⚠ CRASHED | 1 | 仅 1 eval (初始评估), 后即崩溃, 0.860 为 +DPM-Solver++ checkpoint 初始 mAP, **非蒸馏结果** |
...
> **结论**: PD-RF v2/v3/v4 均无法解决 1-step Euler 蒸馏与 4-step DPM-Solver++ 预测的不一致问题。所有 "max mAP" 实际为 step=1 的初始 +DPM-Solver++ checkpoint 评估值, 蒸馏训练开始后 mAP 立即退化 (v3 last=0.421, v4 last=0.324)。**PD-RF 方向在 v1-v4 四次尝试后确认证伪**, 强化 §3.2.2 结论。<!-- verified: 2026-07-19 SwanLab -->
...
> **结论**: Q1 occlusion 训练时 RoI 特征遮挡模拟方向证伪。max mAP=0.836 (17 evals, best@step13) 显著低于 +Stoch. Coupling baseline (0.858), -0.022。训练早期即崩溃, 未能完成 150ep。**方向不进入论文, 归入 §3.2.5 其他方向 (证伪)**。<!-- verified: 2026-07-19 SwanLab -->

#### 3.6.8 Dataset 1 稳定性实验 (项目 `chromosome-kd-stability`)
...
> 本项目仅 1 个实验, 用于验证 Stoch. Coupling 实现的正确性 (V1-E 配置: new OT, col norm, sample, eps=5, iter=20)。

| 实验 | run_id | 配置 | mAP | AP50 | AP75 | APs | APm | APl | 状态 | best@step |
|------|--------|------|-----|------|------|-----|-----|-----|------|-----------|
| V1-E Stoch. Coupling verify seed1 | vqn7zk98wc2dl4wa9cbnr | new OT, col norm, sample, eps=5, iter=20 | 0.745 | 0.943 | 0.836 | 0.515 | 0.735 | 0.649 | ⚠ CRASHED | 55 |

> **结论**: V1-E 验证实验 mAP=0.745, 与 §3.6.1 Stoch. Coupling ε=5 Dataset 1 (0.746-0.749) 同量级, **确认 Stoch. Coupling 实现正确** (V1-E 重采样+列归一化+eps=5+iter=20 配置与 §3.6.1 数值一致)。该实验为实现层验证, 不进入论文, 但支持 §3.6.1 数据有效性。<!-- verified: 2026-07-19 SwanLab -->

#### 3.6.10 ldmdet-sota-stack 数据源 (项目 `ldmdet-sota-stack`, §2.2.6 focal_gamma3 来源)

> 本项目共 3 个实验, 在 Dataset 1 数据集上堆叠 SOTA 组件 (Stoch. Coupling + Focal Loss gamma=3)。仅 1 个实验采集到指标。

| 实验 | run_id | 配置 | mAP | AP50 | AP75 | APs | APm | APl | 状态 | best@step |
|------|--------|------|-----|------|------|-----|-----|-----|------|-----------|
| rf_heun_adaln_stochot_eps5_focal_gamma3_seed42 | o9rlqcu4kaedrygjd78va | RF+Heun+AdaLN+Stoch. Coupling(ε=5)+Focal(γ=3) | 0.751 | 0.943 | 0.840 | 0.521 | 0.745 | 0.679 | ✅ FINISHED | 57 |
...
| 实验类型 | 数量 (估计) | 状态 | 说明 |
|----------|------------|------|------|
| C1 +DPM-Solver++ 多种子推理 | ~6 | FINISHED | §7.2 |
| C2 耦合策略多种子推理 (Dataset 1) | ~12 | FINISHED/CRASHED | §7.3 |
| C4 +DPM-Solver++ 测试集评估 | ~3 | FINISHED/CRASHED | §7.5 |
...
> 以下项目经 SwanLab 同步确认存在, 但与 Dataset 2 论文核心无关, 仅记录项目元数据用于 §0 项目表交叉验证。

| 项目 | 实验数 | 数据集 | 说明 | 是否论文相关 |
|------|--------|--------|------|-------------|
| `chromosome-kd-kcec` | 7 | Dataset 1 | KCCE 对比学习 (kcec_pure_sota, kcec_v2_direct_quota, kcec_v3_scale_aware_gated 等) | ❌ Dataset 1 旧方向 |
| `chromosome-kd-smallobj` | 6 | Dataset 1 | 小目标尺度感知 (smallobj_B_scaleaware_loglinear 已在 §2.2.6 归档) | ❌ Dataset 1 旧方向 |
| `chromosome-kd-arch` | 2 | Dataset 1 | 架构探索 (DINOv2-S backbone 等, 全部证伪, 见 §3.2.5) | ❌ Dataset 1 旧方向 |
| `chromosome-kd-daec` | 2 | Dataset 1 | DAEC 对比学习 (ldmdet_daec_contrastive_kcec_eps5 已在 §2.2.6 归档, mAP=0.740) | ❌ Dataset 1 旧方向 |
...
- **不进入论文正文** 的实验: §3.6.4 (Dataset 1 早期 ε 消融), §3.6.7 (Q1 occlusion), §3.6.8 (Dataset 1 稳定性), §3.6.9 (V1-E 验证), §3.6.10 (focal_gamma3), §3.6.11 (ldmdet-inference 项目级), §3.6.12 (其他 Dataset 1 旧项目)。仅作为数据源溯源与负面证据存档。
- **进入论文正文/附录** 的实验: §3.6.1 (Stoch. Coupling ε 消融, 论文 §4.4.3), §3.6.2 (DPM-Solver++ Dataset 1 历史, 仅 §2.2.6 归档), §3.6.3 (SOTA 多种子, 论文 §4.4.2), §3.6.5 (Adaptive Step/Top-K/Head Early-Exit 训练, §七 C 类推理), §3.6.6 (PD-RF v2/v3/v4, §3.2.2 续)。
- 跳过的实验: `ldmdet-inference` 108 个 (无训练曲线, 已在 §七归档)、`setdiff-24obj` 18 个 (mAP=0, §3.2.1)、`chromosome-kd-*` 早期项目 (与 Dataset 2 主线无关, §3.6.12 已记录元数据)。
...
### 3.7 +Stoch. Coupling (paper Table 5, +Stoch. Coupling) 多种子补充 (2026-07-26 启动)

> **用途**: 论文 Table 5 主消融中 +Stoch. Coupling (`a3_full_sota_24obj`) 当前仅 seed_42 (mAP=0.858), 需补充 seed 123/789 以匹配 DDPM baseline/RF+Heun/+DPM-Solver++ 的 3-seed 统计显著性分析。启动后论文 Table 5 可从 "DDPM baseline–+Stoch. Coupling 为 seed 42, +DPM-Solver++ 为 3-seed 均值" 升级为全部 4 组 3-seed 均值。
>
> **配置**: `experiments/configs/ldmdet/directions/mainline_ablation_24obj/a3_full_sota_24obj_multiseed.py` (基于 `a3_full_sota_24obj.py`, Heun solver + Stoch. Coupling eps5 + AdaLN-Zero, bs=4, 150ep, EarlyStopping patience=30)
>
> **命名对应**: 见 §C4 历史记录(论文与 LINEAGE 代号映射)

| 实验 | seed | 服务器 | GPU | SwanLab run_id | mAP | 状态 | 启动时间 |
|------|------|--------|-----|----------------|-----|------|----------|
| +Stoch. Coupling (paper +Stoch. Coupling) seed_42 (main) | 42 | — | — | (已存在于 §2.1.1) | 0.858 | ✅ FINISHED | 历史 |
| +Stoch. Coupling (paper +Stoch. Coupling) seed_123 | 123 | workstation (hk-a5ks) | GPU 1 (A4000 16GB) | 87i1tfhd | **0.861** (best@ep53) | ✅ FINISHED (EarlyStopping@ep83) | 2026-07-26 02:48 → 2026-07-27 01:26 |
| +Stoch. Coupling (paper +Stoch. Coupling) seed_789 | 789 | workstation (hk-a5ks) | GPU 0 (A5000 24GB) | vn1apdsr | **0.858** (best@ep80) | ✅ FINISHED (EarlyStopping@ep110) | 2026-07-27 03:46 → 2026-07-27 03:48 (实际 ReFlow 重试期间并行完成) |
...
>
> **预期**: +Stoch. Coupling 3-seed 完成后, 论文 Table 5 可更新为全 4 组 3-seed 均值 (DDPM baseline=0.767±0.012, RF+Heun=0.855±0.003, +Stoch. Coupling=TBD, +DPM-Solver++=0.859±0.003), 强化主消融的统计显著性。<!-- 2026-07-26 启动 -->
...
│   ├── ldmdet_rf_heun_adaln_stochot_eps5.py (+AdaLN+Stoch. Coupling eps5)
│   │   └── a3_full_sota_24obj.py (Dataset 2 数据集覆盖)
│   │       └── a4_dpm_pp_24obj.py (+DPM-Solver++)
│   │           └── a4_dpm_pp_24obj_multiseed.py (多种子)
│   └── a1_rf_heun_24obj.py (Dataset 2, 无 AdaLN)
│   └── a2_rf_heun_adaln_24obj.py (Dataset 2, +AdaLN)
│       └── a2_swinglu_24obj.py (+SwiGLU)
│       └── a4_swinglu_24obj.py (+DPM-Solver+++SwiGLU)
├── a0_baseline_24obj.py (Dataset 2, DDPM 基线)

rf_heun_adaln.py (Dataset 1 RF+Heun+AdaLN 基线, bs=4)
├── chromo_24obj_random.py (Dataset 2 Random)
├── ghss.py → chromo_24obj.py (Dataset 2 GHSS)
├── sinkhorn_stochastic.py → chromo_24obj_sinkhorn.py (Dataset 2 Sinkhorn)
└── nonlinear_trajectory*.py (Dataset 1 非线性轨迹系列)
```
...
| rf_heun_adaln.py (Dataset 1) | rectified_flow | heun | adaln_zero | random | shifted | 3.0 | 4 | 4 | 4 | 150 |
...
> † 实际 batch_size: 配置文件中 RF+Heun/+AdaLN-Zero/+Stoch. Coupling/+DPM-Solver++ 继承 bs=2, 但 SwanLab 描述均标注 "bs=8", 推测训练时通过命令行 `--cfg-options train_dataloader.batch_size=8` 覆盖。
...
| OT Flow (multinomial) | ot_flow | 5.0 | 20 | multinomial | OT 传输矩阵多项式采样 (+Stoch. Coupling 配置) |
...
### C1: AdaLN-Zero 消融 (RF+Heun vs +AdaLN-Zero) 结果未在论文中报告

| 项目 | 说明 |
|------|------|
| **问题** | RF+Heun (无 AdaLN) = 0.856, +AdaLN-Zero = 0.856, Δ=+0.000。论文 (AAAI 草稿) 将 RF+Heun + +AdaLN-Zero (LINEAGE RF+Heun + +AdaLN-Zero) 合并为一步 "RF+Heun+AdaLN", 声称 "AdaLN is integrated into RF, not separately ablated" |
...
| **建议** | 如需诚实报告, 应在附录补充 RF+Heun vs +AdaLN-Zero 消融, 说明 AdaLN-Zero 的价值在于训练稳定性而非精度 |

### C2: Random Dataset 2 seed_123 已完成 (✅ 2026-07-26 核实解决)
...
### C3: Stoch. Coupling Dataset 2 有三个不同数值 (0.853/0.856/0.858) 来自不同实验批次
...
| **0.858** | +Stoch. Coupling (a3_full_sota, 2026-07) | ot_flow coupling (eps=5, multinomial), bs=8, classwise eval | ldmdet-mainline-ablation-24obj |

> ⚠ 三者使用不同的耦合实现 (sinkhorn_stochastic vs ot_flow multinomial)、不同的 batch_size (2/4/8)、不同的评估器配置。论文引用 0.858 (+Stoch. Coupling) 作为主路线 SOTA, 0.856 作为耦合消融。0.853 为早期实验, 已被取代。

### C4: 命名统一历史记录 (✅ 已解决)

> **历史问题**: 论文原使用 A0-A3 四级映射 (AdaLN-Zero 合并入 RF+Heun), 本目录原使用 A0-A4 五级映射 (AdaLN-Zero 独立), 导致跨文档引用时 A2/A3 指代不同实验。
>
> **解决方案** (2026-07-27): 全文统一改用描述性名称 (DDPM baseline / RF+Heun / +AdaLN-Zero / +Stoch. Coupling / +DPM-Solver++), 废弃 A0-A4 代号。代号仅保留在文件路径、配置名和 SwanLab run_id 中以兼容工程实现。
>
> **原映射关系** (历史归档):
> - 论文 A0 = DDPM baseline
> - 论文 A1 = RF+Heun+AdaLN (合并) = 本目录 A1+A2
> - 论文 A2 = +Stoch. Coupling = 本目录 A3
> - 论文 A3 = +DPM-Solver++ = 本目录 A4
...
| C6 | SOTA Dataset 1 高方差 | 4-seed: 0.740/0.749/0.746/0.749 (mean 0.746±0.004 sample_std; pop_std=0.0037), 低于 sinkhorn_stochastic 单 seed (0.748)。注: seed_123 有 3 个运行目录, 取最终运行 (0.749), 排除中断值 (0.727)。原 Catalog 误记 0.742±0.008 因采用中断值。 <!-- verified: 2026-07-16 --> |
| C7 | SC-RF SCRF 归因错误 | 0.752 原归功于 ScaleConditionedRF, 实际 SCRF 未集成到 head.py; 真正启用后 0.741 证伪 |
| C8 | ~~Stoch. Coupling Dataset 2 seed_789 缺失~~ ✅ 已解决 <!-- verified: 2026-07-16 --> | Dataset 2 的 Stoch. Coupling ε=5 仍为 1 seed (0.858), 但 original 数据集的 Stoch. Coupling ε=5 已完成 3 seeds (0.746/0.746/0.749, mean 0.747±0.002)。论文 §4.4.1 仍标注 Dataset 2 为 1 seed (准确), §4.4.2 已更新为 3 seeds。 |
| C9 | **SC-RF mAP 原标注 0.857 有误** <!-- verified: 2026-07-16 --> | 本地 `work_dirs/sc_rf_24obj/` scalars.json 实测 max mAP=**0.860** (count=112, best@ep82)。原目录及 EXPERIMENT_RESULTS.md 标注 0.857, 实际 SC-RF **超越 +Stoch. Coupling (0.858) +0.002** 而非 "持平"。但 vs +DPM-Solver++ (0.863) 仍为 -0.003 负增益, 结论 (SC-RF 无显著优势) 不变。SC-RF 已于 2026-07-11 归档, 非 "运行中"。 |
| C10 | **I1 Seesaw / normalized_only 误列入 Dataset 2 节** <!-- verified: 2026-07-16 --> | 配置 `i1_seesaw_normalized.py` 注释明确 "突破 SOTA 0.746 mAP (Dataset 1)", 实为 Dataset 1 数据集实验; 附录 (§6.3) 也正确标注为 Dataset 1。本地 scalars.json 实测 I1 max=0.744 (count=36), normalized_only max=0.747 (count=71), 均为 Dataset 1 量级。误列入 §1.3/§2.1.3 Dataset 2 探索性实验表。 |
...
| 实验组 | 路径 (ross) | 状态 | 本地同步 |
|--------|------------|------|----------|
| DDPM baseline–+DPM-Solver++ 主路线消融 | /media/ross/8TB/.../work_dirs/a{0-4}_*_24obj/ | ✅ 完成 | ✅ 已同步到本地 |
| Dataset 2 耦合消融 (Random/GHSS/Sinkhorn) | /media/ross/8TB/.../work_dirs/24obj_ablation/ | ✅ 完成 | ✅ 已同步 |
| Dataset 1 multi_seed_aug (DDPM/RF/HardOT/Sinkhorn) | /media/ross/8TB/.../work_dirs/multi_seed_aug/ | ✅ 完成 | ✅ 已同步 |
| Dataset 1 SOTA multiseed | /media/ross/8TB/.../work_dirs/sota_seed*/ | ✅ 完成 | ✅ 已同步 |
| Dataset 1 非线性轨迹系列 | /media/ross/8TB/.../work_dirs/nonlinear_trajectory*/ | ✅ 完成 | ✅ 已同步 |
...
| D1 +DPM-Solver++ (trained) seed_789 | /media/ross/8TB/.../work_dirs/a4_dpm_pp_chr2024_seed789/ | ✅ 已完成 (重训修正: 2026-07-31 best 0.746@ep72, early stop@ep102, patience=30; 旧 run 0.724@ep22 异常偏低已废弃) | ✅ 已同步 (本地重训) | <!-- 2026-07-30 旧 run 0.724@ep22 异常偏低; 2026-07-30 17:34 本地重训→2026-07-31 03:13 完成 best 0.746@ep72; 3-seed mean=0.747±0.001 -->
...
| 实验 | 状态 | 说明 |
|------|------|------|
| +DPM-Solver++ seed_123 | ✅ 已完成 (0.857 @ ep62) | +DPM-Solver++ 多种子: 3-seed mean 0.859±0.003 | <!-- verified: 2026-07-16 -->
| +DPM-Solver++ seed_789 | ✅ 已完成 (0.856 @ ep72) | +DPM-Solver++ 多种子完成 | <!-- verified: 2026-07-16 -->
| Stoch. Coupling ε=2 seed_42 (old) | ✅ 已完成 (0.749 @ ep75) | ε 消融补充 | <!-- verified: 2026-07-16 -->
| Stoch. Coupling ε=5 seed_123 (old) | ✅ 已完成 (0.746 @ ep57, ross) | Stoch. Coupling 多种子完成 (3-seed: 0.747±0.002) | <!-- verified: 2026-07-16 -->
| Stoch. Coupling ε=5 seed_789 (old) | ✅ 已完成 (0.749 @ ep69, ross) | Stoch. Coupling 多种子完成 | <!-- verified: 2026-07-16 -->
| SwiGLU 实验 | ✅ 已完成 | +AdaLN-Zero+SwiGLU=0.859, +DPM-Solver+++SwiGLU=0.857 (本地 scalars.json 已确认) | <!-- verified: 2026-07-16 -->
...
| D2 Hard OT seed_789 | 🔄 运行中 (ep80, 2026-08-03 21:11 启动, best 0.860@ep79, ETA ~5h) | 配置 chromo_24obj_hard_ot.py; D2 Hard OT 3-seed 补齐最后一种子; workstation A5000 GPU0; best 已追平 seed_42 (0.860) / seed_123 (0.861) | <!-- 2026-08-03 21:11 启动, 2026-08-04 10:17 更新: ep80 best 0.860@ep79 (ep20→79 从 0.841→0.860) -->
...
本地 `work_dirs/` 共 50 个子目录, 为 ross 服务器的子集同步。本地新增/独立实验:
...
| diagnosis/ | 零成本推理诊断实验 (D1-D5 结构诊断 + 方向 A/D 对比 + D1 消融 + 跨数据集 per-class AP) | ✅ 新增 |
...
> **Baseline 测试参数**: warmup=100, iters=300, CUDA event timing, 512×512, batch=1 (比 RF+Heun–+DPM-Solver++ 的 warmup=10/iters=100 更严谨)
> **mAP 来源**: val (seed42 best checkpoint), 与 FPS 测量用同一 checkpoint; test mAP 见 §7.5 C4

| 模型 | 采样器 | 步数 | 延迟 (ms) | FPS | mAP (val) | mAP (test) |
|------|--------|:---:|----------:|----:|:---------:|:----------:|
| RF+Heun | Heun | 4 | 124.38 ± 3.38 | 8.0 | 0.856 | 0.857 |
| +Stoch. Coupling (Heun) | Heun | 4 | 128.35 ± 1.95 | 7.8 | 0.858 | 0.858 |
| **+DPM-Solver++** | **DPM-Solver++** | **4** | **75.03 ± 0.96** | **13.3** | **0.863** | **0.859** |
| +DPM-Solver++ +Top-K (K=300) | DPM-Solver++ | 4 | 71.27 ± 2.39 | 14.0 | 0.861 | 0.860 |
| **+DPM-Solver++ +Top-K (K=200)** | **DPM-Solver++** | **4** | **70.46 ± 2.28** | **14.2** | **0.860** | **0.859** |
| +DPM-Solver++ +Top-K (K=100) | DPM-Solver++ | 4 | 69.71 ± 1.98 | 14.3 | 0.850 | 0.847 |
...
> 基线: +DPM-Solver++ (mAP=0.863, checkpoint best_epoch_117), 500 张验证图推理, 无 SwanLab
...
> 本节记录 2026-07-25 完成的 5 个新训练实验 (编号 C22-C26, 延续 §五 数据完整性 C 编号体系后的实验编号)。所有实验在 Dataset 2 数据集上进行, 配置文件位于 `experiments/configs/ldmdet/directions/mainline_ablation_24obj/`。详细结果与训练曲线见各实验 work_dir 与 SwanLab 项目。

#### C22: M1 FP32 复现 (核心消融, Dataset 2)
...
- **Best mAP**: **0.862 @ ep19**
- **Last mAP**: 0.859 @ ep30
- **Δ vs +DPM-Solver++ (0.863)**: -0.001 (统计上持平)
...
#### C23: M1 BF16 (workstation) (探索性, Dataset 2)
...
- **Δ vs +DPM-Solver++ (0.863)**: -0.045 (BF16 虚假退化)
- **Δ vs +DPM-Solver+++BF16 (0.825)**: -0.007 (noise 范围但偏负面)
...
#### C24: R3 v-prediction seed 42 (核心消融, Dataset 2)
...
- **Best mAP**: **0.855 @ ep34**
- **Last mAP**: 0.837 @ ep64
- **Δ vs +DPM-Solver++ (0.863)**: -0.008 (超 3-seed noise ±0.003 但偏小, 单 seed 支持 R3.2)
...
- **Δ vs +DPM-Solver++ (0.863)**: -0.004 (在 3-seed noise ±0.003 范围内)
...
#### C26: Head Distillation v2 (探索性, Dataset 2, ⚠ 异常中断)
...
- **配置**: H=3 Student ← H=6 Teacher (+DPM-Solver++ checkpoint 冻结), λ=0.05, freeze backbone, bs=2 (显存 2.4GB, freeze backbone + H=3)
- **Best mAP**: **0.711 @ ep96**
- **Last eval mAP**: 0.709 @ ep98
- **Δ vs +DPM-Solver++ (0.863)**: -0.152 (H=3 学生模型架构容量限制明显)
...
### 6.7 跨数据集 per-class AP 诊断 (2026-07-30 新增)

> 本节为 §6.5 表格中 "跨数据集 per-class AP 诊断" 行的详细展开, 用于解析 D1 训练模型在 D2 test 上 mAP 从 0.753 暴跌至 0.163 的根因 (类别顺序不一致 vs 数据集跨域)。

- **实验**: D1 训练模型 `reproduce_0751_stochot_eps5_v2` (mAP=0.753 on D1 val) 在 D2 test (1000 images) 上推理
- **目的**: 判断跨域检测失效是类别顺序不一致占主导还是数据集跨域占主导
- **结果文件**: `work_dirs/diagnosis/cross_dataset_per_class_20260730_194503.json`
- **脚本**: `experiments/analysis/cross_dataset_per_class.py`
- **整体 mAP**: 0.163 (远低于 D1 的 0.753)

#### 6.7.1 关键发现: 匹配组 vs 不匹配组

| 分组 | 类别数 | 类别范围 | AP mean | AP50 mean | 比值 (不匹配/匹配) |
|------|--------|----------|---------|-----------|--------------------|
| 匹配组 (类别名相同) | 17 | A1-A3, B4-B5, D13-D15, E16-E18, F19-F20, G21-G22, X, Y | 0.2297 | 0.7411 | — |
| 不匹配组 (C 组顺序不同) | 7 | C6/C7/C8/C9/C10/C11/C12 (D1 字母序 vs D2 数字序) | 0.0001 | 0.0007 | **0.0006** |

> ⚠ 不匹配组 7 类的 C 组在 D1 与 D2 之间类别索引顺序不一致:
> - D1 C 组顺序 (按字母序): C10 / C11 / C12 / C6 / C7 / C8 / C9 (索引 5-11)
> - D2 C 组顺序 (按数字序): C6 / C7 / C8 / C9 / C10 / C11 / C12 (索引 5-11)
> - 即同一索引位置对应不同类别名 → D1 训练的模型在 D2 上对 C 组 7 类全部失效 (AP mean=0.0001)

#### 6.7.2 结论

**类别顺序不一致占主导**, 而非数据集跨域。证据:
1. 不匹配组 AP mean (0.0001) 仅为匹配组 (0.2297) 的 **0.0006 倍** (近 1700 倍差距)
2. 匹配组 17 类 AP50 mean=0.7411, 显示 D1 模型在 D2 上对类别名相同的类仍有相当检测能力 (定位正确, 仅 mAP 因 IoU 阈值/数据分布差异下降)
3. 不匹配组 AP50 mean=0.0007 (≈0), 完全失效 — 表明跨域失效主要由类别索引映射错误造成, 而非视觉/数据分布差异

**对 D2 跨域训练 (§2.3.2) 的启示**: 在 D2 上用 D1 配置训练时, 类别顺序应采用 D2 的数字序 (C6→C12), 否则训练会重蹈覆辙。

<!-- 2026-07-30 新增: cross_dataset_per_class.py + JSON 结果; D1 reproduce_0751 mAP=0.753 → D2 test mAP=0.163, 匹配组 AP50=0.7411 远高于不匹配组 0.0007, 证实类别顺序不一致占主导 -->

---

## 附录: 本地 work_dirs 完整目录清单 (50 项)

| 目录 | 数据集 | 说明 | 重要性 |
|------|--------|------|--------|
| 24obj_ablation/ | Dataset 2 | Random/GHSS/Sinkhorn 耦合消融 (3 seeds) | ⭐⭐⭐ |
| a0_baseline_24obj/ | Dataset 2 | DDPM baseline (Euler 1步) | ⭐⭐⭐ |
| a1_rf_heun_24obj/ | Dataset 2 | RF+Heun | ⭐⭐⭐ |
| a2_rf_heun_adaln_24obj/ | Dataset 2 | +AdaLN-Zero | ⭐⭐⭐ |
...
| a4_dpm_pp_chr2024_seed{42,123,789}/ | Dataset 1 | +DPM-Solver++ 在 D1 上训练 3-seed (2026-07-30 新增, 2026-07-31 seed789 重训修正; best 0.746/0.748/0.746, mean 0.747±0.001) | ⭐⭐ |
...
| baselines/ | Dataset 2 + Dataset 1 | 对比模型 (Cascade/DINO/YOLOX/RTMDet/DiffusionDet); Dataset 1 模型在 *_20240904/ 子目录 (2026-07-29 rsync 自 workstation, DINO R50 2026-07-30 训练完成) | ⭐⭐⭐ |
...
| i1_seesaw_normalized/ | Dataset 1 | Seesaw Loss + Normalized Classifier | ⭐⭐ |
| instrumentation*/ | Dataset 1 | 插桩分析 | ⭐ |
| ldmdet_rf_heun_adaln_stochot_eps5/ | Dataset 2 | 早期 Dataset 2 Stoch. Coupling 实验 (0.853) | ⭐⭐ |
| ldmdet_rf_heun_shifted_bs8_aug_v1/v2/v3/ | Dataset 1 | 冗余 checkpoint (v3=156G) | ⭐ |
| merged_ablation/ | merged | 合并数据集训练 | ⭐⭐ |
| multi_dataset/ | — | 多数据集实验 | ⭐ |
| multi_seed/ | Dataset 1 | 无 aug 旧 baseline (非标准) | ⭐ |
| multi_seed_aug/ | Dataset 1 | DDPM/RF/HardOT/Sinkhorn 多种子 (标准 baseline) | ⭐⭐⭐ |
| normalized_only/ | Dataset 1 | Normalized Classifier only | ⭐⭐ |
| optim_test*/ | — | 优化器调试 | ⭐ |
| pd_rf_24obj/ | Dataset 2 | PD-RF 渐进蒸馏 (新增) | ⭐⭐ |
| scheme_a_dinov2_s/ | Dataset 1 | DINOv2-S backbone (证伪) | ⭐ |
| scheme_E_bifpn/ | Dataset 1 | BiFPN (未采用) | ⭐ |
| sc_rf_24obj/ | Dataset 2 | SC-RF 自条件化 RF (✅ 已归档, mAP=0.860) | ⭐⭐ | <!-- verified: 2026-07-16 -->
| setdiff_24obj/ | Dataset 2 | SetDiff Coupled State Diffusion (新增) | ⭐⭐ |
| sota_seed{42,123,456,1000}/ | Dataset 1 | SOTA 多种子 (4 seeds) | ⭐⭐⭐ |
| stability/ | Dataset 1 | warm_restart 稳定性实验 | ⭐ |
...
| 任务 | 优先级 | 目的 | 状态 | 关键结论 |
|------|--------|------|------|---------|
| C1: +DPM-Solver++ 多种子推理 | P0 | 验证主结果 0.863 mAP 跨种子稳定性 | ✅ 完成 | 3-seed mean 0.859±0.003，与 seed 42 单值一致 |
| C2: 耦合多种子推理 | P0 | 验证 Stochastic Coupling 稳定性声明 | ✅ 完成 | Dataset 1 上 Stoch. Coupling vs Random +0.0308 mAP (p<1e-120) |
| C3: 配对显著性检验 | P0 | 关键 mAP 差异的统计检验 | ✅ 完成 | +DPM-Solver++ vs +Stoch. Coupling: Δ=+0.0056, Wilcoxon p=2.54e-07 *** |
| C4: 测试集评估 | P1 | test split 泛化性 | ✅ 完成 | 9 模型全评估 (2026-07-26); +DPM-Solver++ test 0.859 (Δ=−0.004 vs val 0.863), 其余 8 模型 Δ ≤ 0.001 |
| C5: Dataset 1 SOTA 数值核实 | ✅ 已解决 | 论文 RF+Heun+AdaLN 段落三数值核实 | ✅ 完成 | 三个数值 (0.753/0.742/0.737) 均有实验依据 |
...
### 7.2 C1: +DPM-Solver++ 多种子推理结果

> 数据源: C_CLASS_TASK_PLAN.md §10 / C1
> 配置: Dataset 2 val, 500 images, 推理 seed=42, DPM-Solver++ 4-step
...
> ⚠️ 数据完整性问题（已在 §5 数据完整性检查 C1-C16 中记录）：论文 SOTA 表原 +Stoch. Coupling/+DPM-Solver++ 标签串列。两个子代理独立验证（scalars.json + swanlab_export.json）确认论文原 "+Stoch. Coupling" 行数值 0.863/0.583 实际来自 +DPM-Solver++。2026-07-27 命名统一后该问题已消除。
...
| **Stoch. Coupling** | 0.7966 ± 0.0016 | 0.9566 ± 0.0008 | 0.8692 ± 0.0013 | 0.7324 ± 0.0062 | 0.8119 ± 0.0010 | 0.7910 ± 0.0042 |
...
| **Stoch. Coupling** | 0.7956 | 0.7958 | 0.7985 | **0.7966** | ±0.0016 |
...
| Stoch. Coupling | 5 | 42 | 0.745 | 0.941 | 0.832 | 0.510 | 0.738 | 0.638 |
| Stoch. Coupling | 5 | 123 | 0.745 | 0.942 | 0.834 | 0.505 | 0.739 | 0.636 |
| Stoch. Coupling | 5 | 789 | 0.750 | 0.943 | 0.837 | 0.519 | 0.743 | 0.620 |
| **Hard OT (mean±std)** | — | — | 0.705±0.002 | 0.896 | 0.793 | 0.415 | 0.701 | 0.552 |
| **Random (mean±std)** | — | — | 0.713±0.005 | 0.907 | 0.800 | 0.429 | 0.710 | 0.594 |
| **Stoch. Coupling (mean±std)** | — | — | **0.747±0.003** | **0.942** | **0.834** | **0.511** | **0.740** | **0.631** |

#### 7.3.3 配对统计检验 — pooled (跨种子, n=440×3=1320)

| 对比 (metric) | Δ均值 | Wilcoxon p | paired t p | n | 显著性 |
|------|-------|-----------|-----------|---|--------|
| Stoch. Coupling vs Random — mAP@0.5:0.95 | +0.0308 | 9.03e-126 | 9.88e-130 | 1320 | *** |
| Hard OT vs Random — mAP@0.5:0.95 | -0.0061 | 1.20e-08 | 1.59e-09 | 1320 | *** |
| Stoch. Coupling vs Hard OT — mAP@0.5:0.95 | +0.0369 | 8.98e-155 | 2.81e-156 | 1320 | *** |
| Stoch. Coupling vs Random — AP@IoU=0.5 | +0.0298 | 1.61e-128 | 9.69e-126 | 1320 | *** |
| Hard OT vs Random — AP@IoU=0.5 | -0.0087 | 4.51e-17 | 1.30e-18 | 1320 | *** |
| Stoch. Coupling vs Hard OT — AP@IoU=0.5 | +0.0385 | 5.91e-155 | 3.44e-145 | 1320 | *** |
| Stoch. Coupling vs Random — 小目标 AP_S | +0.0450 | 3.89e-68 | 2.50e-75 | 1314 | *** |
| Hard OT vs Random — 小目标 AP_S | -0.0051 | 1.70e-02 | 2.21e-02 | 1314 | * |
| Stoch. Coupling vs Hard OT — 小目标 AP_S | +0.0501 | 1.88e-83 | 5.93e-85 | 1314 | *** |

> 显著性: `*` p<0.05, `**` p<0.01, `***` p<0.001 (Wilcoxon). Pooled 检验将 3 个种子的 per-image AP 拼接 (n=1320)，提供单一 p 值。

#### 7.3.4 关键发现 — Dataset-dependent 结论

> ⚠️ C2 的结论与论文 §4.6 的 "Stoch. Coupling 仅稳定性，无 mAP 增益" 声明在 Dataset 1 上**冲突**，需修订论文表述。

| 对比 | Dataset 1 (Chromosome20240904) | Dataset 2 | 论文当前声明 |
|------|-------------------------------|-------------------|------------|
| Stoch. Coupling vs Random | **+0.034 mAP, p<1e-120** | +0.0001 mAP, p=0.80 | "无 mAP 增益"（仅适用 Dataset 2） |
| Hard OT vs Random | **-0.008 mAP**（更差） | — | "Hard OT 应劣于 Random/Stoch. Coupling" |
| Stoch. Coupling vs Hard OT | +0.037 mAP, p<1e-150 | — | 一致 |

**结论**: Stoch. Coupling 增益是 dataset-dependent 的 — 在小数据集 (Dataset 1, 1540 images) 上高度显著，在大数据集 (Dataset 2, 5000 images) 上统计上等价。论文需修订为 "低数据 regime 高度显著" 而非笼统的 "无 mAP 增益"。
...
| Class | Hard OT mean±std | Random mean±std | Stoch. Coupling mean±std | Δ (Stoch-Hard) |
|-------|------------------|------------------|-------------------|----------------|
...
> 配对构造: 24 类 × 3 seeds = 72 paired (Stoch. Coupling[i] - HardOT[i])
...
> 配置: Dataset 2 val, 500 images, 推理 seed=42
...
|------|-------------|------|-----------------|
| +AdaLN-Zero (Heun) | 0.8943 ± 0.0655 | 0.9936 ± 0.0157 | 0.6321 ± 0.2491 (60) |
| +Stoch. Coupling (Heun) | 0.8944 ± 0.0646 | 0.9944 ± 0.0138 | 0.6333 ± 0.2352 (60) |
| +DPM-Solver++ | 0.9000 ± 0.0645 | 0.9947 ± 0.0133 | 0.6302 ± 0.2514 (60) |

#### 7.4.2 mAP@0.5:0.95 配对检验

| 对比 | Δ均值 | Wilcoxon W | Wilcoxon p | t-statistic | paired t p | n | 显著性 |
|------|-------|-----------|-----------|-------------|-----------|---|--------|
| +Stoch. Coupling vs +AdaLN-Zero (Stoch. Coupling 效应) | +0.0001 | 61544.5 | 7.97e-01 | 0.071 | 9.44e-01 | 500 |  |
| **+DPM-Solver++ vs +Stoch. Coupling (DPM-Solver++ 效应)** | **+0.0056** | **45165.0** | **2.54e-07** | **4.988** | **8.44e-07** | **500** | **\*\*\*** |
| +DPM-Solver++ vs +AdaLN-Zero (联合效应) | +0.0057 | 50858.0 | 4.53e-04 | 4.097 | 4.88e-05 | 500 | *** |

#### 7.4.3 AP@IoU=0.5 配对检验

| 对比 | Δ均值 | Wilcoxon W | Wilcoxon p | t-statistic | paired t p | n | 显著性 |
|------|-------|-----------|-----------|-------------|-----------|---|--------|
| +Stoch. Coupling vs +AdaLN-Zero (Stoch. Coupling 效应) | +0.0009 | 2941.5 | 1.26e-01 | 1.869 | 6.22e-02 | 500 |  |
| +DPM-Solver++ vs +Stoch. Coupling (DPM-Solver++ 效应) | +0.0002 | 2276.0 | 4.87e-01 | 0.710 | 4.78e-01 | 500 |  |
| +DPM-Solver++ vs +AdaLN-Zero (联合效应) | +0.0011 | 2789.0 | 2.76e-02 | 2.393 | 1.71e-02 | 500 | * |

#### 7.4.4 小目标 AP_S 配对检验

| 对比 | Δ均值 | Wilcoxon W | Wilcoxon p | t-statistic | paired t p | n | 显著性 |
|------|-------|-----------|-----------|-------------|-----------|---|--------|
| +Stoch. Coupling vs +AdaLN-Zero (Stoch. Coupling 效应) | +0.0012 | 351.5 | 7.83e-01 | 0.067 | 9.47e-01 | 60 |  |
| +DPM-Solver++ vs +Stoch. Coupling (DPM-Solver++ 效应) | -0.0031 | 437.0 | 8.55e-01 | -0.183 | 8.55e-01 | 60 |  |
| +DPM-Solver++ vs +AdaLN-Zero (联合效应) | -0.0019 | 380.5 | 6.91e-01 | -0.128 | 8.98e-01 | 60 |  |
...
|------|-------|-----------|--------|------------|---------|
| +DPM-Solver++ vs +Stoch. Coupling (DPM-Solver++) | **+0.0056** | **2.54e-07** | **\*\*\*** | "纯计算优势，无精度增益" | "小幅但统计显著的精度优势 (Δ=+0.0056, p=2.54e-07)" |
| +Stoch. Coupling vs +AdaLN-Zero (Stoch. Coupling) | +0.0001 | 0.80 | n.s. | "无 mAP 增益"（适用 Dataset 2） | 一致 — Dataset 2 上统计等价 |
| +DPM-Solver++ vs +AdaLN-Zero (联合) | +0.0057 | 4.53e-04 | *** | — | 联合改进显著 |
...
| **RF (LDMDet Stoch. Coupling)** | 0.8521 | 0.9853 | 0.9657 | 0.4055 | 0.8484 | 0.9058 |
...
⚠️ **+Stoch. Coupling vs +DPM-Solver++ 配置说明 + RTMDet-L ep85 修复** (重要，影响论文叙事):
- 上表 RF mAP=0.8521 是 **+Stoch. Coupling (Heun+Stoch. Coupling) 配置** 的实测值，per-image Wilcoxon 检验也基于 +Stoch. Coupling 预测
- 论文 Table 6 引用的是 **+DPM-Solver++ best (DPM-Solver++ 4-step, seed 42) mAP=0.863** (3-seed mean 0.859±0.003)
- +DPM-Solver++ best 与 DINO R50 的 aggregate mAP 差距: (0.8685 - 0.863) / 0.8685 = **0.63%** (远小于 per-image AP 的 1.64%)
...
- **论文叙事策略** (用户指示 "引用最好的"):
  - §1.2 贡献 1: 引用 +DPM-Solver++ best (0.863) vs DINO R50 (0.8685), 差距仅 **0.63%**
  - 摘要/结论: DiffusionDet 差距用新数据 (RF 0.863 - DiffusionDet 0.8031 = +0.060 mAP)
  - per-image Wilcoxon 表格 (+Stoch. Coupling 配置): 放入草稿补充材料，**暂不放入正文**，避免 +Stoch. Coupling/+DPM-Solver++ 配置混淆
...
**结论**: 9 模型中 8 个 val→test Δ ≤ 0.001, 仅 +DPM-Solver++ 有 −0.004 偏差 (best-checkpoint ep117 对 val 轻微过拟合)。test mAP=0.859 与 val 3-seed mean (0.859±0.003) 完全一致，无系统性过拟合。AP_S point estimate 从 val 的 0.499 摆动到 test 的 0.577（与 main.tex L861-865 一致），反映了小目标 AP_S 的高方差特性（C1 三种子 AP_S std=0.012）。Top-K 剪枝叙事增强: K=300 test 0.860 ≥ +DPM-Solver++ 0.859, K=200 test 0.859 = +DPM-Solver++ 0.859 (完全 free)。
...
#### 7.5.1 Dataset 1 test set per-size AP 评估 (220 images, 2026-07-30 补充)

> 数据源: `work_dirs/diagnosis/test_eval_per_size_20260730_*.json` (ross + workstation 多次评估汇总)
> 配置: Dataset 1 test split (220 images), 各模型 best checkpoint, seed 42 推理
> ⚠ AP75/AP_S/AP_M/AP_L 当前为 — (待补充提取, 评估脚本默认仅输出 mAP/AP50)
...
> 数据源: `work_dirs/diagnosis/test_eval_per_size_20260730_*.json` (ross + workstation 多次评估汇总)
> 配置: Dataset 2 test split (1000 images), 各模型 best checkpoint, seed 42 推理
> ⚠ AP75/AP_S/AP_M/AP_L 当前为 — (待补充提取); D1 model cross-dataset 一行有完整 per-size 数据
...
| **D1 model cross-dataset (reproduce_0751)** | **0.163** | 0.525 | 0.047 | 0.005 | 0.159 | 0.241 |
...
|------|-------|---------------------|-------------|------|------|------|-------|--------|
| Linear (RF+Heun unshifted) | 0 | 0.857 @ ep89 | 0.857 | 0.528 | 0.853 | 0.907 | — | — |
| Shifted (RF+Heun 主实验) | 3.0 | 0.856 | 0.856 | 0.542 | 0.853 | 0.897 | -0.001 | +0.014 |
...
3. +DPM-Solver++ +Top-K (K=200) 的 14.2 FPS 声明已通过 benchmark 验证
4. 复测不会带来新信息，且消耗 GPU 时间

### 7.8 C6: Per-class AP 多种子稳定性

> 数据源: `/tmp/c_class_results/c6_perclass_stability.md`
> 配置: +DPM-Solver++ (DPM-Solver++ 4-step), Dataset 2 val, 3 training seeds [42, 123, 789]
...
#### 7.9.1 9 项关键发现（影响论文表述）

| # | 发现 | 来源 | 当前论文表述 | 修订建议 |
|---|------|------|------------|---------|
| 1 | DPM-Solver++ 在 Dataset 2 上有 +0.0056 mAP 显著增益 | C3 | "纯计算优势，无精度增益" | "小幅但统计显著的精度优势 (p=2.54e-07)" |
| 2 | Stoch. Coupling 在 Dataset 1 上 +0.034 mAP 高度显著 | C2 | "无 mAP 增益"（笼统） | "低数据 regime 高度显著，大数据集统计等价" |
| 3 | Hard OT 在 Dataset 1 上比 Random 差 -0.008 mAP | C2 | "Hard OT 应劣于 Random/Stoch. Coupling" | 一致 — Dataset 1 验证 |
| 4 | +DPM-Solver++ 3-seed mean 0.859±0.003 | C1 | 仅报告 seed 42 单值 0.863 | 报告 mean ± std: 0.859 ± 0.003 |
...
| 8 | RF 落后 DINO R50 仅 0.63% (aggregate mAP, +DPM-Solver++ best) | §7.4.6 (Problem 2B) | "competitive with SOTA" (笼统) | "RF 拉近了与最前沿检测器 (DINO R50) 的差距，aggregate mAP 仅差 0.63% (0.863 vs 0.8685)；与 Cascade R-CNN 性能相当，显著优于 DiffusionDet (+0.060 mAP)"；per-image Wilcoxon (+Stoch. Coupling 配置, 1.64%) 放入草稿补充材料 |
| 9 | DINO R50 D1 训练完成 mAP 0.607→0.742; 跨数据集退化 Δ=−0.126/14.5% (修正原 Δ=−0.261/30.1%) | §1.4/§2.2.7 (2026-07-30) | "DINO R50 在低数据场景退化最严重 (30.1%)" + "KaryoFlow 超越全部标准检测器" | 修订为: DINO R50 D1→D2 退化 14.5%, 与 RTMDet-L (14.0%) 同量级, 不再是退化最显著者 (YOLOX-S 26.0% 退化最显著); KaryoFlow (0.746) 与 DINO R50 (0.742) / RTMDet-L (0.742) 在低数据场景持平 (Δ=+0.004, noise 范围内), 超越 Cascade R-CNN (0.732) / YOLOX-S (0.589); DETR 类大模型对数据量强依赖的论点需修订 |
...
*2026-07-19 SwanLab 同步: §〇 项目表扩至 28 个, §3.2.1 SetDiff 备注, 新增 §3.5 (DDPM baseline/RF+Heun 多种子 + RF+Heun shift 消融, 来源: SwanLab ldmdet-mainline-ablation-24obj + setdiff-24obj)。*
...
*2026-07-31 数据校准 (数据库实验校准): D1 +DPM-Solver++ seed789 重训完成 — best 0.746@ep72 (early stop@ep102, patience=30), 旧 run 0.724@ep22 异常偏低已废弃; 3-seed mean 从 0.739±0.013 修正为 0.747±0.001 (seed42=0.746/seed123=0.748/seed789=0.746)。更新位置: §1.4 L136/L138, §2.2.1 L279, §6.1 L951, §6.2 L967, §6.4 L1170。校准工具: tools/experiment_db/calibrate_docs.py (SQLite 实验数据库)。注: 校准脚本报告的 L88 (Random seed_123) 与 L405 (cross_dataset d2_0753) 为误报 — L88 的 0.814 为首跑中断值 (实际 best 0.860@ep115), L405 的 "D1" 指源配置非数据集 (实验实为 D2)。*
