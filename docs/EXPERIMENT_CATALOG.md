...
> 生成日期: 2026-07-15 | 最近更新: 2026-07-27 (Head Distillation 完成 → LINEAGE §十五; 失败配置证伪 → FALSIFIED §十三; ReFlow 当前run失败+重试中 → FALSIFIED §十四; v2/reflow_standard checkpoint 已清理)
...
| **workstation** (A5000/A4000) | A5000 24GB | 并行多种子 / 消融 | 多种子实验已完成 (+DPM-Solver++ 3-seed, Stoch. Coupling ε=2/5); checkpoint 待 SCP |
...
| **ReFlow (Standard MSE)** 2-RF (重试中) | Dataset 2 | ldmdet-reflow | (reflow_standard) | ⚠ workstation `100.99.131.26`: work_dirs/reflow_standard_24obj/ | reflow_standard_24obj.py | 0.646 (best@ep42, 当前run失败) | ⛔ **当前run失败** (2026-07-27 归档, → [FALSIFIED §十四](file:///home/linkst/workspace/projects/chromosome-kd/docs/FALSIFIED_DIRECTIONS.md)): 配置Bug缺失load_from+lr=1e-5过小+max_epoch=50过短, best 0.646@ep42; 方法风险 mAP_75 崩塌 0.733→0.543; 🔄 重试配置 load_from=A4 best+lr=5e-5+max_epoch=150, 关键判据 mAP_75 是否仍崩塌 | ReFlow | <!-- 2026-07-25 启动, 2026-07-26 完成 50ep best 0.646@ep42; 配置Bug+方法风险; 2026-07-27 归档+清理+重试启动; 详见 §6.6 C28 -->
...
| +Stoch. Coupling (paper +Stoch. Coupling) seed_123 | 123 | workstation (hk-a5ks) | GPU 1 (A4000 16GB) | 87i1tfhd | — | 🔄 RUNNING | 2026-07-26 02:48 |
| +Stoch. Coupling (paper +Stoch. Coupling) seed_789 | 789 | workstation (hk-a5ks) | GPU 0 (A5000 24GB) | — | — | ⏳ PENDING (ReFlow 完成后自动启动) | — |
