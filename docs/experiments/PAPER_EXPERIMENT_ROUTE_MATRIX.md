...
- YAML SHA-256：`fa83ba173fbce4c870ad071392e7a55cec71213ffd0c1b86fb5666259f883c4d`
- 数据库 artifact：`paper-route-matrix-v2-fa83ba173fbc`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=12/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
