...
- YAML SHA-256：`bd52c808bba5cd07a2fa39ff8e773d8fa5e41457c63d987eee403f5dbd41be40`
- 数据库 artifact：`paper-route-matrix-v2-bd52c808bba5`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=30/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
