...
- YAML SHA-256：`630e9d2fc30532d605c138a5a4ed81c3c3e3a72cc0666f7550169a5877d7e636`
- 数据库 artifact：`paper-route-matrix-v2-630e9d2fc305`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=26/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
