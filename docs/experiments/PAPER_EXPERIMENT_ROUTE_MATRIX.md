...
- YAML SHA-256：`f1b7976a603d12c03c53e75bc038f7d779a410988c420414e9d9e508d74b14b5`
- 数据库 artifact：`paper-route-matrix-v2-f1b7976a603d`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=11/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
