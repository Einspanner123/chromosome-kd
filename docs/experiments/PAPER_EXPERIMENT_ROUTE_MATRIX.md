...
- YAML SHA-256：`da503617be7ae014c2e105ba947155aef96fafdd1990f54ead56dc4c9a717262`
- 数据库 artifact：`paper-route-matrix-v2-da503617be7a`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=5/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
