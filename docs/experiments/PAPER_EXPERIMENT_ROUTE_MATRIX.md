...
- YAML SHA-256：`83a6e01644d14b59ad248c9f91c8c2ae458a487ed1cf2acba4609d3d4521d311`
- 数据库 artifact：`paper-route-matrix-v2-83a6e01644d1`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=16/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
