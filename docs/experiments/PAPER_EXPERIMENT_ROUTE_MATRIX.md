...
- YAML SHA-256：`f125a0ad6ebf79f932384aecd6f5f8c32ebc0428074c6e828f020611a329e4c8`
- 数据库 artifact：`paper-route-matrix-v2-f125a0ad6ebf`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=13/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
