...
- YAML SHA-256：`d27bb84c80643e54ed413a7e7ce41e2445ba53af96e11e3c246daf44476b3fe9`
- 数据库 artifact：`paper-route-matrix-v2-d27bb84c8064`
...
- `D1I.INF.solver_steps`：科学因素=3 parents x {Euler,Heun,DPM++} x {1,2,3,4}; report steps and NFE；验收=same checkpoint per parent; common test; no cross-checkpoint causal claim；论文用途=Solver/step accuracy-efficiency ablation；备注=18/36 fixed-parent solver/step held-out test evaluations passed the evidence/database audit; remaining tasks are serialized on Ross A6000.
