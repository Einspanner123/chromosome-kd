...
# Modified from https://github.com/facebookresearch/Mask2Former/blob/main/datasets/prepare_coco_semantic_annos_from_panoptic_annos.py
...
def separate_coco_semantic_from_panoptic(
    ...
    print(f'Start writing to {sem_seg_root} ...')
    start = time.time()
    pool.starmap(
...
if __name__ == '__main__':
    ...
    for s in ['val2017', 'train2017']:
        separate_coco_semantic_from_panoptic(
            ...
            os.path.join(dataset_dir, f'annotations/panoptic_{s}'),
            os.path.join(dataset_dir, f'annotations/panoptic_semseg_{s}'),
            COCO_CATEGORIES,
        )
